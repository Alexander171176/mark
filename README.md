...
`docker exec mark-php-app sh -c "php artisan cache:clear && > storage/logs/laravel.log"`  <br>
...
`docker exec mark-php-app php artisan make:resource Public/School/SchoolLesson/SchoolLessonResource` <br>
