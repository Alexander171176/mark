...
namespace App\Http\Requests\Admin\School\Payment;
    ...
    public function withValidator(Validator $validator): void
    {
        $validator->after(function (Validator $v) {
            ...
            if ($this->filled('user_payment_method_id') && $this->filled('order_id')) {
                $order = \App\Models\Admin\School\Order\Order::query()->find($this->input('order_id'));
                $upm   = \App\Models\Admin\School\UserPaymentMethod\UserPaymentMethod::query()->find($this->input('user_payment_method_id'));
