...
namespace App\Http\Requests\Admin\School\UserPaymentMethod;
        ...
        $validator->after(function (Validator $v) {
            ...
            if (!$userId) {
                ...
                if (is_object($upm)) {
                    ...
                    try {
                        $model = \App\Models\Admin\School\UserPaymentMethod\UserPaymentMethod::query()->findOrFail((int)$upm);
            ...
            if ($userId) {
                $query = \App\Models\Admin\School\UserPaymentMethod\UserPaymentMethod::query()
