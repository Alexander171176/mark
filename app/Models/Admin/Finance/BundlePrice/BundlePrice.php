...
namespace App\Models\Admin\Finance\BundlePrice;
...
/**
 * Цена бандла (мультивалютность/периоды/акции)
 *
 * @property int $id
...
class BundlePrice extends Model
{
    ...
    protected $casts = [
        ...
        // decimal:* в Laravel -> строка (идеально для денег)
        'price'            => 'decimal:2',
    ...
    {
        return $q->where('bundle_id', $bundleId);
    }
