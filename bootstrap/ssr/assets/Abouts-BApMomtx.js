import { useSSRContext, ref, unref, withCtx, createTextVNode } from "vue";
import { ssrRenderAttrs, ssrRenderSlot, ssrRenderComponent, ssrRenderClass, ssrInterpolate } from "vue/server-renderer";
import { Head, Link } from "@inertiajs/vue3";
import { A as ApplicationMark, _ as _sfc_main$3 } from "./ResponsiveNavLink-gtte0z5g.js";
import { _ as _sfc_main$2 } from "./ThemeToggle-DA16u1ft.js";
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(unref(Link), {
        href: "/frontend",
        class: "font-semibold text-gray-600 text-sm px-3 py-1 hover:text-gray-900 dark:text-gray-400 dark:hover:text-white focus:outline focus:outline-2 focus:rounded-sm focus:outline-red-500"
      }, {
      ...
      if (__props.canLogin) {
        ...
        if (_ctx.$page.props.auth.user) {
          _push(ssrRenderComponent(unref(Link), {
            ...
            class: "font-semibold text-gray-600 text-sm mr-2 px-3 py-1 hover:text-gray-900 dark:text-gray-400 dark:hover:text-white focus:outline focus:outline-2 focus:rounded-sm focus:outline-red-500"
          }, {
            default: withCtx((_, _push2, _parent2, _scopeId) => {
              if (_push2) {
