...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    const getInstructorName = (course) => {
      var _a, _b, _c, _d;
      return ((_b = (_a = course == null ? void 0 : course.instructorProfile) == null ? void 0 : _a.translation) == null ? void 0 : _b.title) || ((_d = (_c = course == null ? void 0 : course.instructorProfile) == null ? void 0 : _c.user) == null ? void 0 : _d.name) || t("instructor");
    };
      ...
      ssrRenderList(__props.courses, (course, index) => {
        ...
        _push(ssrRenderComponent(unref(Link), {
          ...
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            var _a2, _b2;
            if (_push2) {
              _push2(`<span class="text-base font-semibold text-slate-900/85 group-hover:opacity-75 dark:text-slate-100/85 dark:group-hover:opacity-75"${_scopeId}>${ssrInterpolate((_a2 = course.translation) == null ? void 0 : _a2.title)}</span>`);
            } else {
              return [
                createVNode("span", { class: "text-base font-semibold text-slate-900/85 group-hover:opacity-75 dark:text-slate-100/85 dark:group-hover:opacity-75" }, toDisplayString((_b2 = course.translation) == null ? void 0 : _b2.title), 1)
              ];
            }
          }),
          _: 2
        ...
        if ((_b = course.translation) == null ? void 0 : _b.short) {
          _push(`<div class="mt-3 line-clamp-3 text-sm text-slate-700 dark:text-slate-300" itemprop="description">${ssrInterpolate(course.translation.short)}</div>`);
        } else {
          _push(`<!---->`);
        }
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("resources/js/Components/Public/Default/School/SchoolCourse/CourseGrid.vue");
