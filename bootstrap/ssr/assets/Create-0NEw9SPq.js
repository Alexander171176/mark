import { ref, computed, mergeProps, unref, withCtx, createTextVNode, toDisplayString, createBlock, openBlock, createVNode, withModifiers, withDirectives, Fragment, renderList, vModelSelect, useSSRContext } from "vue";
...
import { _ as _sfc_main$c } from "./DescriptionTextarea-krO-RNqx.js";
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    const getParentTitle = (category) => {
      var _a2;
      return ((_a2 = category == null ? void 0 : category.translation) == null ? void 0 : _a2.title) || `ID: ${category == null ? void 0 : category.id}`;
    };
    const buildParentOptions = (categories, parentId = null, depth = 0) => {
      const items = Array.isArray(categories) ? categories : [];
      let result = [];
      items.filter((category) => category.parent_id === parentId).sort((a, b) => {
    ...
    const generateMetaFields = () => {
      ...
      if (!translation.meta_keywords && translation.short) {
        ...
        const words = text.split(/\s+/).filter((word) => word && word.length >= 3).map((word) => word.toLowerCase()).filter((value, index, self) => {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(ssrRenderComponent(AdminLayout, mergeProps({
        title: unref(t)("addMarketCategory")
      }, _attrs), {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            if (__props.imageProcessorEnabled && __props.imagePreset) {
              _push2(ssrRenderComponent(_sfc_main$d, {
                preset: __props.imagePreset,
            ...
            _push2(`</div><div class="flex items-center justify-center mt-6 gap-3"${_scopeId}>`);
            _push2(ssrRenderComponent(_sfc_main$1, {
              href: _ctx.route("admin.marketCategories.index")
            }, {
              icon: withCtx((_2, _push3, _parent3, _scopeId2) => {
                  ...
                  createVNode("form", {
                    ...
                    createVNode("div", { class: "mb-4 flex flex-col items-start" }, [
                      ...
                      withDirectives(createVNode("select", {
                        ...
                        createVNode("option", { value: null }, " — " + toDisplayString(unref(t)("rootCategory")) + " — ", 1),
                    ...
                    createVNode("div", { class: "mb-4" }, [
                      __props.imageProcessorEnabled && __props.imagePreset ? (openBlock(), createBlock(_sfc_main$d, {
                        key: 0,
                        preset: __props.imagePreset,
                        "onUpdate:images": handleNewImagesUpdate
                      }, null, 8, ["preset"])) : (openBlock(), createBlock(_sfc_main$e, {
                        key: 1,
                        "onUpdate:images": handleNewImagesUpdate
                      })),
                      createVNode(_sfc_main$6, {
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("resources/js/Pages/Admin/Market/MarketCategories/Create.vue");
