      ...
      _push(ssrRenderComponent(AdminLayout, mergeProps({
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(ssrRenderComponent(_sfc_main$5, {
              id: "completed_at",
              modelValue: unref(form).completed_at,
              "onUpdate:modelValue": ($event) => unref(form).completed_at = $event,
              type: "datetime-local",
              autocomplete: "off",
              class: "w-full"
            }, null, _parent2, _scopeId));
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("resources/js/Pages/Admin/School/SchoolEnrollments/Create.vue");
