...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    const groupsList = computed(() => {
      ...
      if (Array.isArray((_a = props.groups) == null ? void 0 : _a.data)) return props.groups.data;
      return [];
    });
    ...
    const groupTitle = (group) => {
      var _a;
      return ((_a = group == null ? void 0 : group.translation) == null ? void 0 : _a.title) || (group == null ? void 0 : group.code) || `ID: ${group == null ? void 0 : group.id}`;
    };
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(ssrRenderComponent(AdminLayout, mergeProps({
        title: unref(t)("addMarketAttribute")
      }, _attrs), {
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("resources/js/Pages/Admin/Market/MarketAttributes/Create.vue");
