...
import { _ as _sfc_main$k } from "./PrimaryButton-B3InEAXg.js";
...
import { _ as _sfc_main$j } from "./MultiImageUpload-Bg2ahSyk.js";
  ...
  setup(__props) {
    ...
    const moduleOptions = computed(() => {
      return (props.modules || []).map((item) => {
        ...
        const courseTitle = ((_c = (_b = item == null ? void 0 : item.course) == null ? void 0 : _b.translation) == null ? void 0 : _c.title) || ((_d = item == null ? void 0 : item.course) == null ? void 0 : _d.slug) || null;
        return {
          id: item.id,
    ...
    const generateMetaFields = () => {
      ...
      if (!translation.meta_keywords && translation.short) {
        let text = String(translation.short).replace(
          /(<([^>]+)>)/gi,
          ""
        );
        text = text.replace(
      ...
      if (translation.short && !translation.meta_desc) {
        const text = String(translation.short).replace(
          /(<([^>]+)>)/gi,
          ""
        );
    ...
    const submit = () => {
      form.transform((data) => {
        ...
        const transformed = {
          ...
          difficulty,
          duration: data.duration === "" || data.duration === null ? null : Number(
            data.duration
          ),
          preview_value: data.preview_value === "" || data.preview_value === null ? null : Number(
            data.preview_value
          ),
      ...
      _push(ssrRenderComponent(AdminLayout, mergeProps({
          ...
          if (_push2) {
            _push2(ssrRenderComponent(TitlePage, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`${ssrInterpolate(unref(t)("createLesson"))}`);
                } else {
                  return [
                    createTextVNode(toDisplayString(unref(t)("createLesson")), 1)
                  ];
                }
              }),
              _: 1
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(ssrRenderComponent(_sfc_main$j, { "onUpdate:images": handleNewImagesUpdate }, null, _parent2, _scopeId));
                  ...
                  createVNode("form", {
                    ...
                    createVNode("div", { class: "pb-12" }, [
                      ...
                      createVNode("div", { class: "mt-4" }, [
                        createVNode(_sfc_main$j, { "onUpdate:images": handleNewImagesUpdate }),
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("resources/js/Pages/Admin/School/SchoolLessons/Create.vue");
