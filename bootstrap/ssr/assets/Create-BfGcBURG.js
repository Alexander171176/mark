...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    const quizOptionLabel = (quiz) => {
      ...
      const title = ((_a = quiz == null ? void 0 : quiz.translation) == null ? void 0 : _a.title) || (quiz == null ? void 0 : quiz.slug) || `#${quiz.id}`;
      const context = [
        ((_c = (_b = quiz == null ? void 0 : quiz.course) == null ? void 0 : _b.translation) == null ? void 0 : _c.title) ? `Курс: ${quiz.course.translation.title}` : null,
    ...
    const questionOptionLabel = (question) => {
      ...
      const questionText = ((_a = question == null ? void 0 : question.translation) == null ? void 0 : _a.question_text) ? shortText(
        question.translation.question_text
      ) : `#${question.id}`;
      const quizTitle = (_c = (_b = quizOptions.value.find(
        (quiz) => Number(quiz.id) === Number(
          question.school_quiz_id
        )
      )) == null ? void 0 : _b.translation) == null ? void 0 : _c.title;
    ...
    const selectedQuiz = computed({
      ...
      set: (quiz) => {
        ...
        if (form.school_quiz_question_id && Number(quizId) !== Number(
          (_a = selectedQuestion.value) == null ? void 0 : _a.school_quiz_id
        )) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(ssrRenderComponent(AdminLayout, mergeProps({
        title: unref(t)("createQuizAnswer")
      }, _attrs), {
          ...
          if (_push2) {
            _push2(ssrRenderComponent(TitlePage, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`${ssrInterpolate(unref(t)("createQuizAnswer"))}`);
                } else {
                  return [
                    createTextVNode(toDisplayString(unref(t)("createQuizAnswer")), 1)
                  ];
                }
              }),
              _: 1
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("resources/js/Pages/Admin/School/SchoolQuizAnswers/Create.vue");
