import { ref, computed, watch, mergeProps, unref, withCtx, createTextVNode, toDisplayString, createBlock, openBlock, createVNode, withModifiers, createCommentVNode, Fragment, renderList, withDirectives, vModelSelect, useSSRContext } from "vue";
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    const form = useForm({
      ...
      market_shop_id: null,
      currency_id: ((_d = initialCurrencies.find((item) => item.is_default)) == null ? void 0 : _d.id) || ((_e = initialCurrencies[0]) == null ? void 0 : _e.id) || null,
      url: "",
      sku: "",
      vendor_code: "",
      barcode: "",
    ...
    const translationTitle = (item) => {
      var _a2;
      return ((_a2 = item == null ? void 0 : item.translation) == null ? void 0 : _a2.title) || (item == null ? void 0 : item.code) || (item == null ? void 0 : item.sku) || (item == null ? void 0 : item.legal_name) || (item == null ? void 0 : item.name) || (item == null ? void 0 : item.url) || `ID: ${item == null ? void 0 : item.id}`;
    };
    ...
    const variantsForItem = (item) => {
      ...
      const nestedVariants = resourceList(product == null ? void 0 : product.variants);
    ...
    const selectedVariant = (item) => {
      return variantsForItem(item).find((variant) => {
        return Number(variant.id) === Number(item.market_product_variant_id);
      }) || null;
    };
    ...
    const generateMetatags = () => {
      ...
      if (translation.title && !translation.meta_keywords) {
        const words = translation.title.split(/\s+/).filter((word) => word && word.length >= 3).map((word) => word.toLowerCase()).filter((value, index, self) => {
    ...
    const normalizedItems = () => {
      return form.items.map((item, index) => ({
        ...
        market_product_variant_id: item.market_product_variant_id ? Number(item.market_product_variant_id) : null,
        quantity: Math.max(
          1,
    ...
    const submitForm = () => {
      ...
      form.transform((data) => {
        const transformed = {
          ...
          wholesale_min_quantity: data.wholesale_min_quantity === "" || data.wholesale_min_quantity === null ? null : Number(
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(ssrRenderComponent(AdminLayout, mergeProps({
        title: unref(t)("addMarketProductBundle")
      }, _attrs), {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(`</div><div class="mb-3 flex justify-end"${_scopeId}>`);
                ...
                createVNode("div", { class: "p-4 bg-slate-50 dark:bg-slate-700 border border-blue-400 dark:border-blue-200 shadow-lg shadow-gray-500 dark:shadow-slate-400 bg-opacity-95 dark:bg-opacity-95" }, [
                  ...
                  createVNode("form", {
                    ...
                    createVNode("section", { class: "my-3 p-3 border border-slate-300 dark:border-slate-500 bg-white dark:bg-slate-800 rounded-sm" }, [
                      ...
                      createVNode("div", { class: "mb-3 flex justify-end" }, [
                    ...
                    createVNode("section", { class: "mb-5 p-4 border border-blue-300 dark:border-blue-600 bg-blue-50/50 dark:bg-slate-800 rounded-sm" }, [
                      createVNode("div", { class: "flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 mb-4" }, [
                        ...
                        createVNode("button", {
                          type: "button",
                          class: "flex items-center gap-3 px-2 py-0.5 rounded-sm bg-blue-600 hover:bg-blue-700 text-white text-sm",
                          onClick: addItem
                        }, [
                          (openBlock(), createBlock("svg", {
                    ...
                    createVNode("section", { class: "mt-5" }, [
                      __props.imageProcessorEnabled ? (openBlock(), createBlock(_sfc_main$d, {
                        ...
                        preset: galleryPreset.value,
                        "onUpdate:images": handleNewImagesUpdate
                      }, null, 8, ["images", "preset"])) : (openBlock(), createBlock(_sfc_main$e, {
                        key: 1,
                        images: newImages.value,
                        "onUpdate:images": handleNewImagesUpdate
                      }, null, 8, ["images"])),
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("resources/js/Pages/Admin/Market/MarketProductBundles/Create.vue");
