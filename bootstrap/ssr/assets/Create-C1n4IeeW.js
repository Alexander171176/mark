...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    const relatedArticlesOptions = computed(() => {
      var _a;
      return ((_a = props.related_articles) == null ? void 0 : _a.length) ? props.related_articles : props.relatedArticles;
    });
    ...
    const ownerLabel = (item) => {
      var _a, _b, _c, _d;
      const owner = ((_a = item == null ? void 0 : item.owner) == null ? void 0 : _a.name) || ((_b = item == null ? void 0 : item.owner) == null ? void 0 : _b.email) || ((_c = item == null ? void 0 : item.user) == null ? void 0 : _c.name) || ((_d = item == null ? void 0 : item.user) == null ? void 0 : _d.email) || (item == null ? void 0 : item.owner_name) || (item == null ? void 0 : item.owner_email) || "";
      return owner ? String(owner) : "-";
    };
    const baseName = (item) => {
      var _a, _b;
      return String(
        (item == null ? void 0 : item.title) || (item == null ? void 0 : item.name) || ((_a = item == null ? void 0 : item.translation) == null ? void 0 : _a.title) || ((_b = item == null ? void 0 : item.translation) == null ? void 0 : _b.name) || ""
      ).trim() || "—";
    };
    const multiLabel = (item) => {
      ...
      const loc = upperLocale((item == null ? void 0 : item.locale) || ((_a = item == null ? void 0 : item.translation) == null ? void 0 : _a.locale));
    ...
    const submitForm = () => {
      ...
      form.post(route("admin.blogArticles.store"), {
        errorBag: "createBlogArticle",
        preserveScroll: true,
        forceFormData: true,
        onSuccess: () => toast.success("Статья успешно создана!"),
        onError: (errors) => {
      ...
      _push(ssrRenderComponent(AdminLayout, mergeProps({
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(ssrRenderComponent(_sfc_main$6, {
              class: "mt-2",
              message: unref(form).errors.rubrics
            }, null, _parent2, _scopeId));
            ...
            _push2(ssrRenderComponent(_sfc_main$4, { for: "title" }, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<span class="text-red-500 dark:text-red-300 font-semibold"${_scopeId2}>*</span> ${ssrInterpolate(unref(t)("postTitle"))} [${ssrInterpolate(activeLocale.value.toUpperCase())}] `);
                } else {
                  return [
                    createVNode("span", { class: "text-red-500 dark:text-red-300 font-semibold" }, "*"),
                    createTextVNode(" " + toDisplayString(unref(t)("postTitle")) + " [" + toDisplayString(activeLocale.value.toUpperCase()) + "] ", 1)
                  ];
                }
              }),
              _: 1
            ...
            _push2(ssrRenderComponent(unref(VueMultiselect), {
              ...
              options: relatedArticlesOptions.value,
              multiple: true,
              "close-on-select": true,
              placeholder: unref(t)("select"),
              "track-by": "id",
            ...
            _push2(ssrRenderComponent(_sfc_main$4, {
              for: "videos",
              value: unref(t)("videos"),
              class: "mb-1"
            }, null, _parent2, _scopeId));
            _push2(ssrRenderComponent(unref(VueMultiselect), {
              modelValue: unref(form).videos,
              "onUpdate:modelValue": ($event) => unref(form).videos = $event,
              options: __props.videos,
              multiple: true,
              "close-on-select": true,
              placeholder: unref(t)("select"),
              "track-by": "id",
            ...
            _push2(ssrRenderComponent(_sfc_main$6, {
              class: "mt-2",
              message: unref(form).errors.videos
            }, null, _parent2, _scopeId));
            _push2(`</div><div class="mt-4"${_scopeId}>`);
            _push2(ssrRenderComponent(_sfc_main$c, { "onUpdate:images": handleNewImagesUpdate }, null, _parent2, _scopeId));
                ...
                createVNode("div", { class: "p-4 bg-slate-50 dark:bg-slate-700 border border-blue-400 dark:border-blue-200 shadow-lg shadow-gray-500 dark:shadow-slate-400 bg-opacity-95 dark:bg-opacity-95" }, [
                  ...
                  createVNode("form", {
                    ...
                    createVNode("div", { class: "mt-4" }, [
                      createVNode(_sfc_main$c, { "onUpdate:images": handleNewImagesUpdate }),
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("resources/js/Pages/Admin/Blog/BlogArticles/Create.vue");
