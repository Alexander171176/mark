...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    const getBundleTitle = (bundle) => {
      var _a;
      return ((_a = bundle == null ? void 0 : bundle.translation) == null ? void 0 : _a.title) || (bundle == null ? void 0 : bundle.slug) || `#${bundle == null ? void 0 : bundle.id}`;
    };
    ...
    const submitForm = () => {
      ...
      form.post(route("admin.schoolBundlePrices.store"), {
        preserveScroll: true,
        onSuccess: () => {
          toast.success("Цена набора курсов успешно создана.");
        },
        onError: (errors) => {
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("resources/js/Pages/Admin/School/SchoolBundlePrices/Create.vue");
