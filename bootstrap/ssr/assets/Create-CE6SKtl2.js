  ...
  setup(__props) {
    ...
    function buildParentOptions(flatTracks, parentId = null, level = 0) {
      ...
      (flatTracks || []).filter(
        ...
        var _a;
        const name = ((_a = track == null ? void 0 : track.translation) == null ? void 0 : _a.name) || `ID: ${track.id}`;
        result.push({
          id: track.id,
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(ssrRenderComponent(AdminLayout, mergeProps({
        title: unref(t)("addLearningCategory")
      }, _attrs), {
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("resources/js/Pages/Admin/School/SchoolTracks/Create.vue");
