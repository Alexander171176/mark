  ...
  setup(__props) {
    ...
    const instructorProfileOptions = computed(
      () => props.instructorProfiles.map((item) => {
        var _a, _b, _c;
        const title = ((_a = item == null ? void 0 : item.translation) == null ? void 0 : _a.title) || ((_b = item == null ? void 0 : item.user) == null ? void 0 : _b.name) || `#${item.id}`;
    ...
    const trackOptions = computed(
      () => props.tracks.map((item) => {
        ...
        return {
          id: item.id,
          label: `[ID: ${item.id}] ${((_a = item == null ? void 0 : item.translation) == null ? void 0 : _a.name) || (item == null ? void 0 : item.slug) || `#${item.id}`}`
        };
      })
    );
    ...
    const relatedCourseOptions = computed(
      () => props.courses.map((item) => {
        ...
        return {
          id: item.id,
          label: `[ID: ${item.id}] ${((_a = item == null ? void 0 : item.translation) == null ? void 0 : _a.title) || (item == null ? void 0 : item.slug) || `#${item.id}`}`
        };
      })
    );
    ...
    const submit = () => {
      form.transform((data) => {
        ...
        const transformed = {
          ...
          school_instructor_profile_id: ((_a = selectedInstructorProfile.value) == null ? void 0 : _a.id) ?? null,
          ...
          related_course_ids: Array.isArray(selectedRelatedCourses.value) ? selectedRelatedCourses.value.map((v) => v.id) : []
        };
          ...
          if (_push2) {
            _push2(ssrRenderComponent(TitlePage, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`${ssrInterpolate(unref(t)("createCourse"))}`);
                } else {
                  return [
                    createTextVNode(toDisplayString(unref(t)("createCourse")), 1)
                  ];
                }
              }),
              _: 1
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("resources/js/Pages/Admin/School/SchoolCourses/Create.vue");
