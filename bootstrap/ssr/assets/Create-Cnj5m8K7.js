...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    const submitForm = () => {
      ...
      form.post(route("admin.marketAttributeGroups.store"), {
        errorBag: "createMarketAttributeGroup",
        preserveScroll: true,
        onSuccess: () => {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(ssrRenderComponent(AdminLayout, mergeProps({
        title: unref(t)("addMarketAttributeGroup")
      }, _attrs), {
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("resources/js/Pages/Admin/Market/MarketAttributeGroups/Create.vue");
