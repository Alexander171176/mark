...
import { _ as _sfc_main$7, a as _sfc_main$8 } from "./SelectAvailability-DaDlzU8Q.js";
/* empty css                                                                      */
      ...
      _push(ssrRenderComponent(AdminLayout, mergeProps({
          ...
          if (_push2) {
            _push2(ssrRenderComponent(TitlePage, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`${ssrInterpolate(unref(t)("createModule"))}`);
                } else {
                  return [
                    createTextVNode(toDisplayString(unref(t)("createModule")), 1)
                  ];
                }
              }),
              _: 1
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(ssrRenderComponent(_sfc_main$g, { "onUpdate:images": handleNewImagesUpdate }, null, _parent2, _scopeId));
                  ...
                  createVNode("form", {
                    ...
                    createVNode("div", { class: "pb-12" }, [
                      ...
                      createVNode("div", { class: "mt-4" }, [
                        createVNode(_sfc_main$g, { "onUpdate:images": handleNewImagesUpdate }),
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("resources/js/Pages/Admin/School/SchoolModules/Create.vue");
