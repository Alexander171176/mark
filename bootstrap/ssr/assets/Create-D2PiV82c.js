...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    const truncateText = (text, maxLength, addEllipsis = false) => {
      ...
      const truncated = lastSpaceIndex === -1 ? string.substring(0, maxLength) : string.substring(0, lastSpaceIndex);
    ...
    const submitForm = () => {
      ...
      form.post(
        route("admin.cmsPages.store"),
        {
          errorBag: "createCmsPage",
          preserveScroll: true,
          onSuccess: () => {
            toast.success(
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("resources/js/Pages/Admin/Cms/CmsPages/Create.vue");
