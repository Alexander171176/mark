...
import _sfc_main$1 from "./CreateTeamForm-9MMgz8YU.js";
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(ssrRenderComponent(AppLayout, mergeProps({
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div${_scopeId}><div class="bg-gray-100 dark:bg-slate-900 bg-opacity-90 dark:bg-opacity-90 max-w-7xl mx-auto py-10 sm:px-6 lg:px-8 h-lvh"${_scopeId}>`);
            _push2(ssrRenderComponent(_sfc_main$1, null, null, _parent2, _scopeId));
            _push2(`</div></div>`);
          } else {
            return [
              createVNode("div", null, [
                createVNode("div", { class: "bg-gray-100 dark:bg-slate-900 bg-opacity-90 dark:bg-opacity-90 max-w-7xl mx-auto py-10 sm:px-6 lg:px-8 h-lvh" }, [
