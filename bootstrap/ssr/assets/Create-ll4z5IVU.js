...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    const getInstructorTitle = (item) => {
      var _a2, _b, _c;
      return ((_a2 = item == null ? void 0 : item.translation) == null ? void 0 : _a2.title) || ((_b = item == null ? void 0 : item.translation) == null ? void 0 : _b.public_name) || (item == null ? void 0 : item.public_name) || (item == null ? void 0 : item.title) || ((_c = item == null ? void 0 : item.user) == null ? void 0 : _c.name) || `#${(item == null ? void 0 : item.id) ?? ""}`;
    };
    ...
    const instructorOptions = computed(
      () => (props.instructors || []).map(
        (item) => {
          ...
          const userName = ((_a2 = item == null ? void 0 : item.user) == null ? void 0 : _a2.name) || ((_b = item == null ? void 0 : item.user) == null ? void 0 : _b.email) || "";
          return {
            id: item.id,
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(ssrRenderComponent(AdminLayout, mergeProps({
        title: unref(t)("createCourseSchedule")
      }, _attrs), {
          ...
          if (_push2) {
            _push2(ssrRenderComponent(TitlePage, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`${ssrInterpolate(unref(t)("createCourseSchedule"))}`);
                } else {
                  return [
                    createTextVNode(toDisplayString(unref(t)("createCourseSchedule")), 1)
                  ];
                }
              }),
              _: 1
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("resources/js/Pages/Admin/School/SchoolCourseSchedules/Create.vue");
