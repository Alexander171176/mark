              ...
              createVNode("div", { class: "col-span-6" }, [
                ...
                createVNode("div", { class: "flex items-center mt-2" }, [
                  ...
                  createVNode("div", { class: "ms-4 leading-tight" }, [
                    createVNode("div", { class: "font-semibold text-orange-400 text-sm" }, toDisplayString(_ctx.$page.props.auth.user.name), 1),
                    createVNode("div", { class: "font-semibold text-teal-600 text-sm" }, toDisplayString(_ctx.$page.props.auth.user.email), 1)
                  ])
                ])
              ]),
