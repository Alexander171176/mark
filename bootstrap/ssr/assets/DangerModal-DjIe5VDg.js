...
import { ssrRenderTeleport, ssrRenderStyle, ssrRenderClass, ssrInterpolate } from "vue/server-renderer";
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("resources/js/Components/Admin/UI/Modal/DangerModal.vue");
