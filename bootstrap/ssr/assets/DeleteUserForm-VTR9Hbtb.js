...
import { _ as _sfc_main$2 } from "./DangerButton-CnCACk3P.js";
import { _ as _sfc_main$3 } from "./DialogModal-qFgExXTx.js";
import { _ as _sfc_main$5, a as _sfc_main$6 } from "./TextInput-CCxUFX3K.js";
import { _ as _sfc_main$4 } from "./SecondaryButton-05lGdtfU.js";
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(ssrRenderComponent(_sfc_main$1, _attrs, {
        ...
        content: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="max-w-xl font-semibold text-sm text-indigo-900 dark:text-sky-200"${_scopeId}>${ssrInterpolate(unref(t)("deleteAccountWarning"))}</div><div class="mt-5"${_scopeId}>`);
            ...
            return [
              createVNode("div", { class: "max-w-xl font-semibold text-sm text-indigo-900 dark:text-sky-200" }, toDisplayString(unref(t)("deleteAccountWarning")), 1),
