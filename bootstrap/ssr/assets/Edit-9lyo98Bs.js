...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    const buildTranslations = () => {
      ...
      const defaultLocale2 = props.currentLocale || ((_a2 = props.tag.translation) == null ? void 0 : _a2.locale) || props.availableLocales[0] || "ru";
    ...
    const defaultLocale = props.currentLocale || ((_a = props.tag.translation) == null ? void 0 : _a.locale) || props.availableLocales[0] || "ru";
    ...
    const pageTitle = computed(() => {
      var _a2;
      return currentTranslation.value.name || ((_a2 = props.tag.translation) == null ? void 0 : _a2.name) || `ID: ${props.tag.id}`;
    });
    const getError = (key) => {
    ...
    const submitForm = () => {
      ...
      form.post(route("admin.blogTags.update", { blogTag: props.tag.id }), {
        errorBag: "editBlogTag",
        preserveScroll: true,
        onSuccess: () => toast.success("Тег успешно обновлён!"),
        onError: (errors) => {
          console.error("Не удалось обновить тег:", errors);
      ...
      _push(ssrRenderComponent(AdminLayout, mergeProps({
          ...
          if (_push2) {
            _push2(ssrRenderComponent(TitlePage, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`${ssrInterpolate(unref(t)("editTag"))}: ${ssrInterpolate(pageTitle.value)} [ID: ${ssrInterpolate(props.tag.id)}] `);
                } else {
                  return [
                    createTextVNode(toDisplayString(unref(t)("editTag")) + ": " + toDisplayString(pageTitle.value) + " [ID: " + toDisplayString(props.tag.id) + "] ", 1)
                  ];
                }
              }),
              _: 1
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(`</div></div><div class="flex items-center justify-center mt-6"${_scopeId}>`);
            _push2(ssrRenderComponent(_sfc_main$1, {
              href: _ctx.route("admin.blogTags.index")
            }, {
              icon: withCtx((_2, _push3, _parent3, _scopeId2) => {
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("resources/js/Pages/Admin/Blog/BlogTags/Edit.vue");
