...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    const buildTranslations = () => {
      var _a2, _b2, _c2;
      const result = {};
      (props.question.translations || []).forEach(
        (translation) => {
      ...
      const locale = props.currentLocale || ((_b2 = (_a2 = props.question) == null ? void 0 : _a2.translation) == null ? void 0 : _b2.locale) || ((_c2 = props.availableLocales) == null ? void 0 : _c2[0]) || "ru";
    ...
    const defaultLocale = props.currentLocale || ((_b = (_a = props.question) == null ? void 0 : _a.translation) == null ? void 0 : _b.locale) || ((_c = props.availableLocales) == null ? void 0 : _c[0]) || "ru";
    const activeLocale = ref(
      defaultLocale
    );
    const form = useForm({
      _method: "PUT",
      school_quiz_id: props.question.school_quiz_id ?? ((_d = props.question.quiz) == null ? void 0 : _d.id) ?? null,
      ...
      meta_raw: props.question.meta ? JSON.stringify(
        props.question.meta,
        null,
        2
      ) : "",
    ...
    const pageTitle = computed(() => {
      var _a2, _b2;
      return stripHtml(
        currentTranslation.value.question_text || ((_b2 = (_a2 = props.question) == null ? void 0 : _a2.translation) == null ? void 0 : _b2.question_text) || `ID: ${props.question.id}`
      );
    });
    const getError = (key) => {
    ...
    const quizOptionLabel = (quiz) => {
      ...
      const context = [
        ((_c2 = (_b2 = quiz == null ? void 0 : quiz.lesson) == null ? void 0 : _b2.translation) == null ? void 0 : _c2.title) ? `Урок: ${quiz.lesson.translation.title}` : null,
        ((_e = (_d2 = quiz == null ? void 0 : quiz.module) == null ? void 0 : _d2.translation) == null ? void 0 : _e.title) ? `Модуль: ${quiz.module.translation.title}` : null,
    ...
    const submitForm = () => {
      form.transform(
        (data) => {
          ...
          return {
            ...
            sort: data.sort === "" || data.sort === null ? 0 : Number(
              data.sort
            ),
            points: data.points === "" || data.points === null ? 1 : Number(
              data.points
            ),
            meta: parseMeta(
              meta_raw
      ...
      form.post(
        route(
          "admin.schoolQuizQuestions.update",
          {
        ...
        ),
        {
          ...
          onSuccess: () => {
            toast.success(
              "Вопрос квиза успешно обновлён!"
            );
          },
          onError: (errors) => {
            console.error(
              "Ошибка обновления вопроса квиза:",
              errors
            );
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(ssrRenderComponent(AdminLayout, mergeProps({
        title: unref(t)("editQuizQuestion")
      }, _attrs), {
          ...
          if (_push2) {
            _push2(ssrRenderComponent(TitlePage, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`${ssrInterpolate(unref(t)("editQuizQuestion"))}: ${ssrInterpolate(pageTitle.value)} [ID: ${ssrInterpolate(props.question.id)}] `);
                } else {
                  return [
                    createTextVNode(toDisplayString(unref(t)("editQuizQuestion")) + ": " + toDisplayString(pageTitle.value) + " [ID: " + toDisplayString(props.question.id) + "] ", 1)
                  ];
                }
              }),
              _: 1
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("resources/js/Pages/Admin/School/SchoolQuizQuestions/Edit.vue");
