...
import { _ as _sfc_main$d } from "./DescriptionTextarea-krO-RNqx.js";
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    const categoryData = computed(() => {
      var _a2;
      return ((_a2 = props.category) == null ? void 0 : _a2.data) ?? props.category;
    });
    ...
    const defaultLocale = props.currentLocale || ((_a = categoryData.value.translation) == null ? void 0 : _a.locale) || props.availableLocales[0] || "ru";
    ...
    const form = useForm({
      _method: "PUT",
      user_id: categoryData.value.user_id || ((_d = (_c = (_b = page.props) == null ? void 0 : _b.auth) == null ? void 0 : _c.user) == null ? void 0 : _d.id) || null,
    ...
    const pageTitle = computed(() => {
      var _a2;
      return currentTranslation.value.title || ((_a2 = categoryData.value.translation) == null ? void 0 : _a2.title) || `ID: ${categoryData.value.id}`;
    });
    const getError = (key) => {
    ...
    const existingImages = ref(
      (Array.isArray(categoryData.value.images) ? categoryData.value.images : []).filter((image) => {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(ssrRenderComponent(AdminLayout, mergeProps({
        title: unref(t)("editMarketCategory")
      }, _attrs), {
          ...
          if (_push2) {
            _push2(ssrRenderComponent(TitlePage, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`${ssrInterpolate(unref(t)("editMarketCategory"))}: ${ssrInterpolate(pageTitle.value)} [ID: ${ssrInterpolate(categoryData.value.id)}] `);
                } else {
                  return [
                    createTextVNode(toDisplayString(unref(t)("editMarketCategory")) + ": " + toDisplayString(pageTitle.value) + " [ID: " + toDisplayString(categoryData.value.id) + "] ", 1)
                  ];
                }
              }),
              _: 1
                ...
                createVNode("div", { class: "p-4 bg-slate-50 dark:bg-slate-700 border border-blue-400 dark:border-blue-200 shadow-lg shadow-gray-500 dark:shadow-slate-400 bg-opacity-95 dark:bg-opacity-95" }, [
                  ...
                  createVNode("form", {
                    ...
                    createVNode("div", { class: "mt-4" }, [
                      __props.imageProcessorEnabled && __props.imagePreset ? (openBlock(), createBlock(Fragment, { key: 0 }, [
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("resources/js/Pages/Admin/Market/MarketCategories/Edit.vue");
