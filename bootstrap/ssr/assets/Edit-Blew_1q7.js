...
import { _ as _sfc_main$7, a as _sfc_main$8 } from "./CategorySelect-Bs_IXYvt.js";
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    const { t } = useI18n();
    const props = __props;
    const setting = ((_a = props.setting) == null ? void 0 : _a.data) ?? props.setting ?? {};
    const form = useForm({
      sort: setting.sort ?? 0,
      type: setting.type ?? "",
      ...
      activity: Boolean(setting.activity ?? false)
    });
    const handleOptionInput = (event) => {
      ...
      form.option = cleaned.charAt(0).toLowerCase() + cleaned.slice(1);
    };
    const toUpperCaseWithUnderscore = (str) => {
      return str.trim().replace(/[-\s]+/g, "_").replace(/([A-Z]+)([A-Z][a-z])/g, "$1_$2").replace(/([a-z0-9])([A-Z])/g, "$1_$2").replace(/_+/g, "_").toUpperCase();
    };
      ...
      _push(ssrRenderComponent(AdminLayout, mergeProps({
          ...
          if (_push2) {
            _push2(ssrRenderComponent(TitlePage, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`${ssrInterpolate(unref(t)("editParameter"))} ID: ${ssrInterpolate(unref(setting).id)}`);
                } else {
                  return [
                    createTextVNode(toDisplayString(unref(t)("editParameter")) + " ID: " + toDisplayString(unref(setting).id), 1)
                  ];
                }
              }),
              _: 1
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(`</div><form class="p-3 w-full"${_scopeId}><div class="mb-3 flex justify-between flex-col lg:flex-row items-center gap-3"${_scopeId}><div class="flex justify-between w-full"${_scopeId}><div class="flex flex-row items-center"${_scopeId}>`);
            ...
            _push2(`</div></div><div class="mb-3 flex justify-between flex-col lg:flex-row items-center gap-3"${_scopeId}><div class="flex flex-row items-center"${_scopeId}>`);
            _push2(ssrRenderComponent(_sfc_main$4, {
              for: "category",
            ...
            _push2(ssrRenderComponent(_sfc_main$1, {
              ...
              icon: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<svg class="w-4 h-4 fill-current text-slate-100 shrink-0 mr-2" viewBox="0 0 16 16"${_scopeId2}><path d="M4.3 4.5c1.9-1.9
                                           5.1-1.9 7 0
                                           .7.7 1.2 1.7 1.4 2.7
                                           l2-.3c-.2-1.5-.9-2.8
                                           -1.9-3.8C10.1.4
                                           5.7.4 2.9 3.1L.7.9
                                           0 7.3l6.4-.7-2.1-2.1z"${_scopeId2}></path></svg>`);
                } else {
                  return [
                    (openBlock(), createBlock("svg", {
                      class: "w-4 h-4 fill-current text-slate-100 shrink-0 mr-2",
                      ...
                      createVNode("path", { d: "M4.3 4.5c1.9-1.9\n                                           5.1-1.9 7 0\n                                           .7.7 1.2 1.7 1.4 2.7\n                                           l2-.3c-.2-1.5-.9-2.8\n                                           -1.9-3.8C10.1.4\n                                           5.7.4 2.9 3.1L.7.9\n                                           0 7.3l6.4-.7-2.1-2.1z" })
                    ]))
                  ];
                }
              }),
            ...
            _push2(ssrRenderComponent(_sfc_main$b, {
              ...
              icon: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<svg class="w-4 h-4 fill-current text-slate-100" viewBox="0 0 16 16"${_scopeId2}><path d="M14.3 2.3L5 11.6
                                           1.7 8.3c-.4-.4-1-.4
                                           -1.4 0-.4.4-.4 1
                                           0 1.4l4 4c.2.2.4.3
                                           .7.3.3 0 .5-.1.7-.3
                                           l10-10c.4-.4.4-1
                                           0-1.4-.4-.4-1-.4-1.4 0z"${_scopeId2}></path></svg>`);
                } else {
                  return [
                    (openBlock(), createBlock("svg", {
                      ...
                      createVNode("path", { d: "M14.3 2.3L5 11.6\n                                           1.7 8.3c-.4-.4-1-.4\n                                           -1.4 0-.4.4-.4 1\n                                           0 1.4l4 4c.2.2.4.3\n                                           .7.3.3 0 .5-.1.7-.3\n                                           l10-10c.4-.4.4-1\n                                           0-1.4-.4-.4-1-.4-1.4 0z" })
                    ]))
                  ];
                }
              }),
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("resources/js/Pages/Admin/System/Parameters/Edit.vue");
