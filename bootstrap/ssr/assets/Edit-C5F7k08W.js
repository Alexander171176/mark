...
import { _ as _sfc_main$d } from "./MultiImageEdit-BZZHL0n1.js";
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    const defaultLocale = props.currentLocale || ((_a = props.bundle.translation) == null ? void 0 : _a.locale) || ((_b = props.availableLocales) == null ? void 0 : _b[0]) || "ru";
    ...
    const form = useForm({
       ...
       * выбранных Courses.
       */
      course_ids: (props.bundle.courses || []).map((course) => course.id),
    ...
    const pageTitle = computed(() => {
      var _a2;
      return currentTranslation.value.title || ((_a2 = props.bundle.translation) == null ? void 0 : _a2.title) || `ID: ${props.bundle.id}`;
    });
    const getError = (key) => {
    ...
    const selectedCourses = computed({
      ...
      set: (courses) => {
        form.course_ids = Array.isArray(courses) ? courses.map(
          (course) => course.id
        ) : [];
      }
    });
    const existingImages = ref(
      (props.bundle.images || []).filter(
          ...
          if (_push2) {
            _push2(ssrRenderComponent(TitlePage, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`${ssrInterpolate(unref(t)("editBundle"))}: ${ssrInterpolate(pageTitle.value)} [ID: ${ssrInterpolate(__props.bundle.id)}] `);
                } else {
                  return [
                    createTextVNode(toDisplayString(unref(t)("editBundle")) + ": " + toDisplayString(pageTitle.value) + " [ID: " + toDisplayString(__props.bundle.id) + "] ", 1)
                  ];
                }
              }),
              _: 1
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("resources/js/Pages/Admin/School/SchoolBundles/Edit.vue");
