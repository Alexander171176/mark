import { mergeProps, unref, withCtx, createTextVNode, toDisplayString, createBlock, openBlock, createVNode, createCommentVNode, withModifiers, Fragment, renderList, useSSRContext } from "vue";
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    const form = useForm({
      ...
      permissions: [...((_b = props.role) == null ? void 0 : _b.permissions) || []]
    });
    const submit = () => {
      ...
      _push(ssrRenderComponent(AdminLayout, mergeProps({
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          ...
          if (_push2) {
            ...
            _push2(`</div></form>`);
            if ((_a2 = props.role.permissions) == null ? void 0 : _a2.length) {
              ...
              ssrRenderList(props.role.permissions || [], (rolePermission) => {
                ...
                _push2(ssrRenderComponent(_sfc_main$6, {
                  href: _ctx.route("admin.roles.permissions.destroy", [props.role.id, rolePermission.id])
                }, null, _parent2, _scopeId));
                _push2(`</div></td></tr>`);
              });
              ...
              createVNode("div", { class: "px-4 sm:px-6 lg:px-8 py-8 w-full max-w-12xl mx-auto" }, [
                createVNode("div", { class: "p-4 bg-slate-50 dark:bg-slate-700 border border-blue-400 dark:border-blue-200 shadow-lg shadow-gray-500 dark:shadow-slate-400 bg-opacity-95 dark:bg-opacity-95" }, [
                  ...
                  createVNode("div", { class: "py-4 flex flex-wrap justify-around relative bg-white dark:bg-slate-700" }, [
                    ...
                    ((_b2 = props.role.permissions) == null ? void 0 : _b2.length) ? (openBlock(), createBlock("div", {
                      key: 0,
                      ...
                      createVNode("div", { class: "overflow-x-auto" }, [
                        createVNode("table", { class: "table-auto w-full" }, [
                          ...
                          createVNode("tbody", { class: "text-sm divide-y divide-slate-200 dark:text-slate-100" }, [
                            (openBlock(true), createBlock(Fragment, null, renderList(props.role.permissions || [], (rolePermission) => {
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("resources/js/Pages/Admin/System/Roles/Edit.vue");
