...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    const valueData = computed(() => {
      var _a2;
      return ((_a2 = props.value) == null ? void 0 : _a2.data) || props.value || {};
    });
    const attributesList = computed(() => {
      var _a2;
      if (Array.isArray(props.attributes)) return props.attributes;
      if (Array.isArray((_a2 = props.attributes) == null ? void 0 : _a2.data)) return props.attributes.data;
      return [];
    });
    ...
    const attributeTitle = (attribute) => {
      var _a2;
      return ((_a2 = attribute == null ? void 0 : attribute.translation) == null ? void 0 : _a2.title) || `ID: ${attribute == null ? void 0 : attribute.id}`;
    };
    const attributeTypeTitle = (type) => {
      var _a2;
      return ((_a2 = attributeTypes.value.find(
        (item) => item.value === type
      )) == null ? void 0 : _a2.label) || type || "";
    };
    ...
    const makeTranslations = () => {
      var _a2;
      const result = {};
      const translations = ((_a2 = valueData.value) == null ? void 0 : _a2.translations) || [];
      ...
      const currentLocale = props.currentLocale || "ru";
      if (!result[currentLocale]) {
        result[currentLocale] = makeTranslation();
      }
      return result;
    };
    const defaultLocale = props.currentLocale || ((_b = (_a = valueData.value) == null ? void 0 : _a.translation) == null ? void 0 : _b.locale) || "ru";
    ...
    const form = useForm({
      ...
      moderation_status: Number(
        valueData.value.moderation_status ?? 0
      ),
    ...
    const pageTitle = computed(() => {
      var _a2;
      return currentTranslation.value.title || ((_a2 = valueData.value.translation) == null ? void 0 : _a2.title) || `ID: ${valueData.value.id}`;
    });
    const getError = (key) => {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(ssrRenderComponent(AdminLayout, mergeProps({
        title: unref(t)("editMarketAttributeValue")
      }, _attrs), {
          ...
          if (_push2) {
            _push2(ssrRenderComponent(TitlePage, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`${ssrInterpolate(unref(t)("editMarketAttributeValue"))}: ${ssrInterpolate(pageTitle.value)} [ID: ${ssrInterpolate(valueData.value.id)}] `);
                } else {
                  return [
                    createTextVNode(toDisplayString(unref(t)("editMarketAttributeValue")) + ": " + toDisplayString(pageTitle.value) + " [ID: " + toDisplayString(valueData.value.id) + "] ", 1)
                  ];
                }
              }),
              _: 1
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("resources/js/Pages/Admin/Market/MarketAttributeValues/Edit.vue");
