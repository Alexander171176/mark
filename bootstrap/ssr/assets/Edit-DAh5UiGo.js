import { computed, ref, mergeProps, unref, withCtx, createTextVNode, toDisplayString, createBlock, openBlock, createVNode, withModifiers, withDirectives, Fragment, renderList, vModelSelect, vModelText, useSSRContext } from "vue";
...
const _sfc_main = {
  ...
  props: {
    attribute: { type: [Object, null], default: null },
  ...
  setup(__props) {
    ...
    const attributeData = computed(() => {
      var _a2;
      return ((_a2 = props.attribute) == null ? void 0 : _a2.data) || props.attribute || {};
    });
    const pageTitle = computed(() => {
      var _a2;
      return currentTranslation.value.title || ((_a2 = attributeData.value.translation) == null ? void 0 : _a2.title) || `ID: ${attributeData.value.id}`;
    });
    const groupsList = computed(() => {
      var _a2;
      if (Array.isArray(props.groups)) return props.groups;
      if (Array.isArray((_a2 = props.groups) == null ? void 0 : _a2.data)) return props.groups.data;
      return [];
    });
    const groupTitle = (group) => {
      var _a2;
      return ((_a2 = group == null ? void 0 : group.translation) == null ? void 0 : _a2.title) || (group == null ? void 0 : group.code) || `ID: ${group == null ? void 0 : group.id}`;
    };
    ...
    const makeTranslations = () => {
      var _a2;
      const result = {};
      const translations = ((_a2 = attributeData.value) == null ? void 0 : _a2.translations) || [];
      const list = Array.isArray(translations == null ? void 0 : translations.data) ? translations.data : translations;
    ...
    const defaultLocale = props.currentLocale || ((_b = (_a = attributeData.value) == null ? void 0 : _a.translation) == null ? void 0 : _b.locale) || "ru";
    const activeLocale = ref(defaultLocale);
    const form = useForm({
      _method: "put",
      market_attribute_group_id: attributeData.value.market_attribute_group_id || "",
      code: attributeData.value.code || "",
      icon: attributeData.value.icon || "",
      color: attributeData.value.color || "#3b82f6",
      type: attributeData.value.type || "string",
      unit: attributeData.value.unit || "",
      ...
      status: attributeData.value.status || "draft",
      moderation_status: Number(attributeData.value.moderation_status ?? 0),
      moderated_by: attributeData.value.moderated_by || null,
      moderated_at: attributeData.value.moderated_at || null,
      moderation_note: attributeData.value.moderation_note || "",
      published_at: attributeData.value.published_at || "",
      show_from_at: attributeData.value.show_from_at || "",
      show_to_at: attributeData.value.show_to_at || "",
    ...
    const submitForm = () => {
      ...
      form.post(route("admin.marketAttributes.update", {
        marketAttribute: attributeData.value.id
      }), {
        errorBag: "editMarketAttribute",
        preserveScroll: true,
        onSuccess: () => {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(ssrRenderComponent(AdminLayout, mergeProps({
        title: unref(t)("editMarketAttribute")
      }, _attrs), {
          ...
          if (_push2) {
            _push2(ssrRenderComponent(TitlePage, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`${ssrInterpolate(unref(t)("editMarketAttribute"))}: ${ssrInterpolate(pageTitle.value)} [ID: ${ssrInterpolate(attributeData.value.id)}] `);
                } else {
                  return [
                    createTextVNode(toDisplayString(unref(t)("editMarketAttribute")) + ": " + toDisplayString(pageTitle.value) + " [ID: " + toDisplayString(attributeData.value.id) + "] ", 1)
                  ];
                }
              }),
              _: 1
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(`</div></div><div class="mb-3 flex flex-wrap items-center justify-between gap-5"${_scopeId}><div class="flex flex-row items-center gap-2"${_scopeId}>`);
            _push2(ssrRenderComponent(_sfc_main$2, {
              modelValue: unref(form).required,
              "onUpdate:modelValue": ($event) => unref(form).required = $event
            }, null, _parent2, _scopeId));
            _push2(ssrRenderComponent(_sfc_main$3, {
              for: "required",
              text: unref(t)("required"),
              class: "text-sm h-8 flex items-center"
            }, null, _parent2, _scopeId));
            _push2(`</div><div class="flex flex-row items-center gap-2"${_scopeId}>`);
            _push2(ssrRenderComponent(_sfc_main$2, {
              modelValue: unref(form).filterable,
              "onUpdate:modelValue": ($event) => unref(form).filterable = $event
            }, null, _parent2, _scopeId));
            _push2(ssrRenderComponent(_sfc_main$3, {
              for: "filterable",
              text: unref(t)("showFilter"),
              class: "text-sm h-8 flex items-center"
            }, null, _parent2, _scopeId));
            _push2(`</div><div class="flex flex-row items-center gap-2"${_scopeId}>`);
            _push2(ssrRenderComponent(_sfc_main$2, {
            ...
            _push2(ssrRenderComponent(_sfc_main$3, {
              for: "visible",
              text: unref(t)("visibleCard"),
              class: "text-sm h-8 flex items-center"
            }, null, _parent2, _scopeId));
            _push2(`</div><div class="flex flex-row items-center gap-2"${_scopeId}>`);
            _push2(ssrRenderComponent(_sfc_main$2, {
              modelValue: unref(form).use_for_variants,
              "onUpdate:modelValue": ($event) => unref(form).use_for_variants = $event
            }, null, _parent2, _scopeId));
            _push2(ssrRenderComponent(_sfc_main$3, {
              for: "use_for_variants",
              text: unref(t)("showInVariants"),
              class: "text-sm h-8 flex items-center"
            }, null, _parent2, _scopeId));
            _push2(`</div></div><div class="mb-3 flex flex-col items-start"${_scopeId}>`);
            _push2(ssrRenderComponent(_sfc_main$4, { for: "market_attribute_group_id" }, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<span class="text-red-500 dark:text-red-300 font-semibold"${_scopeId2}>*</span> ${ssrInterpolate(unref(t)("group"))}`);
                } else {
                  return [
                    createVNode("span", { class: "text-red-500 dark:text-red-300 font-semibold" }, "*"),
                    createTextVNode(" " + toDisplayString(unref(t)("group")), 1)
                  ];
                }
              }),
              _: 1
            }, _parent2, _scopeId));
            _push2(`<select id="market_attribute_group_id" required class="w-full px-2 py-0.5 form-select bg-white text-gray-600 border border-slate-400 dark:border-slate-600 rounded-sm shadow-sm dark:bg-cyan-800 dark:text-slate-100"${_scopeId}><option value=""${ssrIncludeBooleanAttr(Array.isArray(unref(form).market_attribute_group_id) ? ssrLooseContain(unref(form).market_attribute_group_id, "") : ssrLooseEqual(unref(form).market_attribute_group_id, "")) ? " selected" : ""}${_scopeId}>${ssrInterpolate(unref(t)("select"))}</option><!--[-->`);
            ssrRenderList(groupsList.value, (group) => {
              _push2(`<option${ssrRenderAttr("value", group.id)}${ssrIncludeBooleanAttr(Array.isArray(unref(form).market_attribute_group_id) ? ssrLooseContain(unref(form).market_attribute_group_id, group.id) : ssrLooseEqual(unref(form).market_attribute_group_id, group.id)) ? " selected" : ""}${_scopeId}>${ssrInterpolate(groupTitle(group))}</option>`);
            });
            _push2(`<!--]--></select>`);
            _push2(ssrRenderComponent(_sfc_main$6, {
              class: "mt-2",
              message: unref(form).errors.market_attribute_group_id
            }, null, _parent2, _scopeId));
            ...
            _push2(`<select id="type" class="w-full px-2 py-0.5 form-select bg-white text-gray-600 border border-slate-400 dark:border-slate-600 rounded-sm shadow-sm dark:bg-cyan-800 dark:text-slate-100"${_scopeId}><!--[-->`);
            ssrRenderList(attributeTypes, (type) => {
              _push2(`<option${ssrRenderAttr("value", type.value)}${ssrIncludeBooleanAttr(Array.isArray(unref(form).type) ? ssrLooseContain(unref(form).type, type.value) : ssrLooseEqual(unref(form).type, type.value)) ? " selected" : ""}${_scopeId}>${ssrInterpolate(type.label)}</option>`);
            });
            _push2(`<!--]--></select>`);
            _push2(ssrRenderComponent(_sfc_main$6, {
              class: "mt-2",
              ...
              createVNode("div", { class: "px-4 sm:px-6 lg:px-8 py-8 w-full max-w-12xl mx-auto" }, [
                createVNode("div", { class: "p-4 bg-slate-50 dark:bg-slate-700 border border-blue-400 dark:border-blue-200 shadow-lg shadow-gray-500 dark:shadow-slate-400 bg-opacity-95 dark:bg-opacity-95" }, [
                  ...
                  createVNode("form", {
                    ...
                    createVNode("div", { class: "mb-3 flex flex-wrap items-center justify-between gap-5" }, [
                      createVNode("div", { class: "flex flex-row items-center gap-2" }, [
                        createVNode(_sfc_main$2, {
                          modelValue: unref(form).required,
                          "onUpdate:modelValue": ($event) => unref(form).required = $event
                    ...
                    createVNode("div", { class: "mb-3 flex flex-col items-start" }, [
                      createVNode(_sfc_main$4, { for: "market_attribute_group_id" }, {
                        default: withCtx(() => [
                          createVNode("span", { class: "text-red-500 dark:text-red-300 font-semibold" }, "*"),
                          createTextVNode(" " + toDisplayString(unref(t)("group")), 1)
                        ]),
                      ...
                      withDirectives(createVNode("select", {
                        ...
                        "onUpdate:modelValue": ($event) => unref(form).market_attribute_group_id = $event,
                        required: "",
                        ...
                        (openBlock(true), createBlock(Fragment, null, renderList(groupsList.value, (group) => {
                          return openBlock(), createBlock("option", {
                            key: group.id,
                            value: group.id
                          }, toDisplayString(groupTitle(group)), 9, ["value"]);
                        }), 128))
                      ], 8, ["onUpdate:modelValue"]), [
                        [vModelSelect, unref(form).market_attribute_group_id]
                      ]),
                      createVNode(_sfc_main$6, {
                        class: "mt-2",
                        message: unref(form).errors.market_attribute_group_id
                    ...
                    createVNode("div", { class: "grid grid-cols-1 md:grid-cols-2 gap-3 mb-3" }, [
                      createVNode("div", { class: "flex flex-col items-start" }, [
                        ...
                        withDirectives(createVNode("select", {
                          ...
                          (openBlock(), createBlock(Fragment, null, renderList(attributeTypes, (type) => {
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("resources/js/Pages/Admin/Market/MarketAttributes/Edit.vue");
