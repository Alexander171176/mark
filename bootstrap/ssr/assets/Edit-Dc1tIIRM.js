...
import { _ as _sfc_main$b } from "./MultiImageUpload-Bg2ahSyk.js";
import { _ as _sfc_main$a } from "./MultiImageEdit-BZZHL0n1.js";
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    const buildTranslations = () => {
      var _a2;
      const result = {};
      (props.banner.translations || []).forEach((translation) => {
      ...
      const defaultLocale2 = props.currentLocale || ((_a2 = props.banner.translation) == null ? void 0 : _a2.locale) || props.availableLocales[0] || "ru";
    ...
    const defaultLocale = props.currentLocale || ((_a = props.banner.translation) == null ? void 0 : _a.locale) || props.availableLocales[0] || "ru";
    const activeLocale = ref(defaultLocale);
    const form = useForm({
      _method: "PUT",
      sort: props.banner.sort ?? 0,
      activity: Boolean(props.banner.activity ?? false),
      left: Boolean(props.banner.left ?? false),
      main: Boolean(props.banner.main ?? false),
      right: Boolean(props.banner.right ?? false),
    ...
    const pageTitle = computed(() => {
      var _a2;
      return currentTranslation.value.title || ((_a2 = props.banner.translation) == null ? void 0 : _a2.title) || `ID: ${props.banner.id}`;
    });
    const getError = (key) => {
      return form.errors[`translations.${activeLocale.value}.${key}`];
    };
    const existingImages = ref(
      (props.banner.images || []).filter((img) => img.url || img.webp_url || img.image_url || img.thumb_url).map((img) => ({
        id: img.id,
    ...
    const submitForm = () => {
      ...
      form.post(route("admin.blogBanners.update", { blogBanner: props.banner.id }), {
        errorBag: "editBlogBanner",
        preserveScroll: true,
        forceFormData: true,
        onSuccess: () => {
        ...
        onError: (errors) => {
          console.error("Не удалось обновить баннер:", errors);
      ...
      _push(ssrRenderComponent(AdminLayout, mergeProps({
          ...
          if (_push2) {
            _push2(ssrRenderComponent(TitlePage, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`${ssrInterpolate(unref(t)("editBanner"))}: ${ssrInterpolate(pageTitle.value)} [ID: ${ssrInterpolate(props.banner.id)}] `);
                } else {
                  return [
                    createTextVNode(toDisplayString(unref(t)("editBanner")) + ": " + toDisplayString(pageTitle.value) + " [ID: " + toDisplayString(props.banner.id) + "] ", 1)
                  ];
                }
              }),
              _: 1
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(ssrRenderComponent(_sfc_main$b, { "onUpdate:images": handleNewImagesUpdate }, null, _parent2, _scopeId));
                ...
                createVNode("div", { class: "p-4 bg-slate-50 dark:bg-slate-700 border border-blue-400 dark:border-blue-200 shadow-lg shadow-gray-500 dark:shadow-slate-400 bg-opacity-95 dark:bg-opacity-95" }, [
                  ...
                  createVNode("form", {
                    ...
                    createVNode("div", { class: "mt-4" }, [
                      ...
                      createVNode(_sfc_main$b, { "onUpdate:images": handleNewImagesUpdate }),
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("resources/js/Pages/Admin/Blog/BlogBanners/Edit.vue");
