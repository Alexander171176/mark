import { mergeProps, unref, withCtx, createTextVNode, toDisplayString, createBlock, openBlock, createVNode, withModifiers, Fragment, renderList, useSSRContext } from "vue";
...
import { _ as _sfc_main$5 } from "./DeleteButton-CcPx65ti.js";
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    const form = useForm({
      ...
      roles: [...((_c = props.user) == null ? void 0 : _c.roles) || []],
      permissions: [...((_d = props.user) == null ? void 0 : _d.permissions) || []]
    });
    const submit = () => {
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("resources/js/Pages/Admin/System/Users/Edit.vue");
