...
import { _ as _sfc_main$c } from "./MultiImageEdit-BZZHL0n1.js";
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    const buildTranslations = () => {
      ...
      const locale = props.currentLocale || ((_b2 = (_a2 = props.quiz) == null ? void 0 : _a2.translation) == null ? void 0 : _b2.locale) || ((_c2 = props.availableLocales) == null ? void 0 : _c2[0]) || "ru";
    ...
    const defaultLocale = props.currentLocale || ((_b = (_a = props.quiz) == null ? void 0 : _a.translation) == null ? void 0 : _b.locale) || ((_c = props.availableLocales) == null ? void 0 : _c[0]) || "ru";
    ...
    const form = useForm({
      _method: "PUT",
      school_course_id: props.quiz.school_course_id ?? ((_d = props.quiz.course) == null ? void 0 : _d.id) ?? null,
      school_module_id: props.quiz.school_module_id ?? ((_e = props.quiz.module) == null ? void 0 : _e.id) ?? null,
      school_lesson_id: props.quiz.school_lesson_id ?? ((_f = props.quiz.lesson) == null ? void 0 : _f.id) ?? null,
      activity: Boolean(
        props.quiz.activity
      ),
      left: Boolean(
      ...
      published_at: normalizeDateTimeLocal(
    ...
    const pageTitle = computed(() => {
      var _a2, _b2;
      return currentTranslation.value.title || ((_b2 = (_a2 = props.quiz) == null ? void 0 : _a2.translation) == null ? void 0 : _b2.title) || `ID: ${props.quiz.id}`;
    });
    const getError = (key) => {
    ...
    const moduleOptions = computed(
      () => props.modules.map(
        (module) => {
          ...
          const courseTitle = ((_c2 = (_b2 = module == null ? void 0 : module.course) == null ? void 0 : _b2.translation) == null ? void 0 : _c2.title) || ((_d2 = module == null ? void 0 : module.course) == null ? void 0 : _d2.slug) || "";
          return {
            id: module.id,
    ...
    const lessonOptions = computed(
      () => props.lessons.map(
        (lesson) => {
          ...
          const moduleTitle = ((_c2 = (_b2 = lesson == null ? void 0 : lesson.module) == null ? void 0 : _b2.translation) == null ? void 0 : _c2.title) || ((_d2 = lesson == null ? void 0 : lesson.module) == null ? void 0 : _d2.slug) || "";
          const courseTitle = ((_g = (_f2 = (_e2 = lesson == null ? void 0 : lesson.module) == null ? void 0 : _e2.course) == null ? void 0 : _f2.translation) == null ? void 0 : _g.title) || ((_i = (_h = lesson == null ? void 0 : lesson.module) == null ? void 0 : _h.course) == null ? void 0 : _i.slug) || "";
    ...
    watch(
      ...
      (lessonId) => {
        ...
        const courseId = ((_b2 = lesson.module) == null ? void 0 : _b2.school_course_id) ?? ((_c2 = lesson.module) == null ? void 0 : _c2.course_id) ?? ((_e2 = (_d2 = lesson.module) == null ? void 0 : _d2.course) == null ? void 0 : _e2.id) ?? null;
        if (courseId) {
    ...
    watch(
      ...
      (moduleId) => {
        ...
        if (form.school_lesson_id) {
          const lesson = selectedLessonEntity.value;
          const lessonModuleId = (lesson == null ? void 0 : lesson.school_module_id) ?? (lesson == null ? void 0 : lesson.module_id) ?? ((_b2 = lesson == null ? void 0 : lesson.module) == null ? void 0 : _b2.id) ?? null;
    ...
    watch(
      ...
      (courseId) => {
        ...
        if (form.school_lesson_id) {
          const lesson = selectedLessonEntity.value;
          const lessonCourseId = ((_b2 = lesson == null ? void 0 : lesson.module) == null ? void 0 : _b2.school_course_id) ?? ((_c2 = lesson == null ? void 0 : lesson.module) == null ? void 0 : _c2.course_id) ?? ((_e2 = (_d2 = lesson == null ? void 0 : lesson.module) == null ? void 0 : _d2.course) == null ? void 0 : _e2.id) ?? null;
    ...
    const existingImages = ref(
      (props.quiz.images || []).filter(
        (image) => image.webp_url || image.url || image.image_url
      ).map(
        (image) => ({
          id: image.id,
          ...
          if (_push2) {
            _push2(ssrRenderComponent(TitlePage, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`${ssrInterpolate(unref(t)("editQuiz"))}: ${ssrInterpolate(pageTitle.value)} [ID: ${ssrInterpolate(__props.quiz.id)}] `);
                } else {
                  return [
                    createTextVNode(toDisplayString(unref(t)("editQuiz")) + ": " + toDisplayString(pageTitle.value) + " [ID: " + toDisplayString(__props.quiz.id) + "] ", 1)
                  ];
                }
              }),
              _: 1
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("resources/js/Pages/Admin/School/SchoolQuizzes/Edit.vue");
