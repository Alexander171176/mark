          ...
          if (_push2) {
            ...
            _push2(ssrRenderComponent(HeadingAuth, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`${ssrInterpolate(unref(t)("passwordReset"))}`);
                } else {
                  return [
            ...
            _push2(`<div class="mb-4 font-semibold text-md text-gray-900 dark:text-gray-300"${_scopeId}>${ssrInterpolate(unref(t)("forgotPasswordMessage"))}</div><form${_scopeId}><div${_scopeId}>`);
            ...
            _push2(ssrRenderComponent(_sfc_main$6, {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`${ssrInterpolate(unref(t)("resetPasswordLink"))}`);
                } else {
                  return [
                    ...
                    createVNode("div", { class: "min-h-screen h-full flex flex-col justify-center items-center" }, [
                      ...
                      createVNode("div", { class: "flex flex-col justify-center items-center max-w-sm mx-auto px-4 py-8" }, [
                        ...
                        createVNode("div", null, [
                          ...
                          createVNode("div", { class: "mb-4 font-semibold text-md text-gray-900 dark:text-gray-300" }, toDisplayString(unref(t)("forgotPasswordMessage")), 1),
                          createVNode("form", {
