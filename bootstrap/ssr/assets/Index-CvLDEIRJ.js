...
_sfc_main$3.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("resources/js/Components/Admin/System/Permission/Sort/SortSelect.vue");
...
const _sfc_main$2 = {
  ...
  setup(__props, { emit: __emit }) {
    ...
    const emit = __emit;
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "bg-white dark:bg-slate-700 shadow-lg rounded-sm border border-slate-400 dark:border-slate-500 relative" }, _attrs))}><div class="overflow-x-auto">`);
      if (__props.permissions.length > 0) {
        _push(`<table class="table-auto w-full text-slate-700 dark:text-slate-100"><thead class="text-sm font-semibold uppercase bg-slate-200 dark:bg-cyan-900 border border-solid border-gray-300 dark:border-gray-700"><tr><th class="px-2 first:pl-5 last:pr-5 py-3 whitespace-nowrap w-px"><div class="font-semibold text-center">${ssrInterpolate(unref(t)("id"))}</div></th><th class="px-2 first:pl-5 last:pr-5 py-3 whitespace-nowrap"><div class="font-semibold text-left">${ssrInterpolate(unref(t)("name"))}</div></th><th class="px-2 first:pl-5 last:pr-5 py-3 whitespace-nowrap"><div class="font-semibold text-left">Guard</div></th><th class="px-2 first:pl-5 last:pr-5 py-3 whitespace-nowrap"><div class="font-semibold text-left">${ssrInterpolate(unref(t)("roles"))}</div></th><th class="px-2 first:pl-5 last:pr-5 py-3 whitespace-nowrap"><div class="font-semibold text-end">${ssrInterpolate(unref(t)("actions"))}</div></th></tr></thead><tbody><!--[-->`);
        ssrRenderList(__props.permissions, (permission) => {
          _push(`<tr class="text-sm font-semibold border-b-2 hover:bg-slate-100 dark:hover:bg-cyan-800"><td class="px-2 first:pl-5 last:pr-5 py-1 whitespace-nowrap"><div class="text-center">${ssrInterpolate(permission.id)}</div></td><td class="px-2 first:pl-5 last:pr-5 py-1 whitespace-nowrap"><div class="text-left text-teal-600 dark:text-violet-200">${ssrInterpolate(permission.name)}</div></td><td class="px-2 first:pl-5 last:pr-5 py-1 whitespace-nowrap"><div class="text-left text-amber-600 dark:text-amber-200">${ssrInterpolate(permission.guard_name || "—")}</div></td><td class="px-2 first:pl-5 last:pr-5 py-1"><div class="flex flex-wrap gap-1"><!--[-->`);
          ssrRenderList(permission.roles || [], (role) => {
          ...
          _push(ssrRenderComponent(_sfc_main$5, {
            onClick: ($event) => emit("delete", permission.id, permission.name)
          }, null, _parent));
          _push(`</div></td></tr>`);
        });
        _push(`<!--]--></tbody></table>`);
...
_sfc_main$2.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("resources/js/Components/Admin/System/Permission/Table/PermissionTable.vue");
  return _sfc_setup$2 ? _sfc_setup$2(props, ctx) : void 0;
};
const _sfc_main$1 = {
  __name: "PermissionCardGrid",
  __ssrInlineRender: true,
  props: {
    permissions: { type: Array, default: () => [] }
  },
  ...
  setup(__props, { emit: __emit }) {
    ...
    const emit = __emit;
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "bg-white dark:bg-slate-700 shadow-lg rounded-sm border border-slate-400 dark:border-slate-500 relative" }, _attrs))}><div class="flex items-center justify-between px-3 py-2 border-b border-slate-400 dark:border-slate-500"><div class="text-xs text-slate-600 dark:text-slate-200">${ssrInterpolate(unref(t)("permissions"))}: ${ssrInterpolate(__props.permissions.length)}</div></div>`);
      if (__props.permissions.length) {
        _push(`<div class="p-3"><div class="grid gap-3 grid-cols-1 sm:grid-cols-2 lg:grid-cols-4"><!--[-->`);
        ssrRenderList(__props.permissions, (permission) => {
          _push(`<article class="relative flex flex-col h-full rounded-md border border-slate-400 dark:border-slate-500 bg-slate-50/70 dark:bg-slate-800/80 shadow-sm hover:shadow-md transition-shadow duration-150"><header class="flex items-center justify-between px-2 py-1 border-b border-dashed border-slate-400 dark:border-slate-500"><div class="w-full flex flex-row items-center justify-start gap-2"><span class="w-fit text-[10px] font-semibold px-1.5 py-0.5 rounded-sm border border-gray-400 bg-slate-200 dark:bg-slate-700 text-slate-800 dark:text-blue-100 whitespace-nowrap"> ID: ${ssrInterpolate(permission.id)}</span><span class="w-full text-[14px] font-semibold text-center text-teal-700 dark:text-teal-200 line-clamp-2"${ssrRenderAttr("title", permission.name)}>${ssrInterpolate(permission.name)}</span></div></header><div class="flex-1 px-3 py-2">`);
          if (permission.guard_name) {
            _push(`<div class="text-[14px] text-gray-600 dark:text-gray-200 text-center mb-2"> guard: <span class="text-amber-600 dark:text-amber-200 font-semibold">${ssrInterpolate(permission.guard_name)}</span></div>`);
          } else {
            _push(`<!---->`);
          }
          _push(`<div class="text-[14px] text-slate-700 dark:text-slate-100 mb-1 text-center">${ssrInterpolate(unref(t)("roles"))} <span class="text-xs text-gray-500 dark:text-gray-300"> (${ssrInterpolate(permission.roles_count ?? 0)}) </span></div><div class="flex flex-wrap justify-center gap-1"><!--[-->`);
          ssrRenderList(permission.roles || [], (role) => {
            _push(`<span class="px-1.5 py-0.5 bg-slate-100 dark:bg-slate-800 border border-dashed border-gray-400 text-orange-500 dark:text-orange-200 text-[12px] font-semibold rounded-sm">${ssrInterpolate(role.name)}</span>`);
          });
          _push(`<!--]-->`);
          if (!permission.roles || permission.roles.length === 0) {
...
_sfc_main$1.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("resources/js/Components/Admin/System/Permission/View/PermissionCardGrid.vue");
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    const permissionsList = computed(() => {
      ...
      if (Array.isArray((_a = props.permissions) == null ? void 0 : _a.data)) return props.permissions.data;
      return [];
    });
    ...
    const itemsPerPage = ref(
      props.adminSystemPermissionsPerPage || props.adminCountPermissions || 20
    );
    ...
    const sortParam = ref(
      props.sortParam || props.adminSystemPermissionsDefaultSort || props.adminSortPermissions || "nameAsc"
    );
    ...
    const getRolesText = (permission) => {
      const roles = Array.isArray(permission == null ? void 0 : permission.roles) ? permission.roles : [];
      return roles.map((role) => (role == null ? void 0 : role.name) || "").filter(Boolean).join(" ");
    };
    ...
    const filteredPermissions = computed(() => {
      ...
      filtered = filtered.filter((permission) => {
        const searchableValues = [
          normalize(permission == null ? void 0 : permission.name),
          normalize(permission == null ? void 0 : permission.guard_name),
          normalize(getRolesText(permission))
        ];
        return searchWords.value.every((word) => {
          if (/^\d+$/.test(word) && safeNumber(permission == null ? void 0 : permission.id) === Number(word)) {
            return true;
          }
    ...
    const displayedPermissions = computed(() => {
      return props.useServerProcessing ? permissionsList.value : paginatedPermissions.value;
    });
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(ssrRenderComponent(_sfc_main$7, {
              ...
              mode: __props.adminSystemPermissionsProcessingMode,
              "use-server-processing": __props.useServerProcessing,
              total: __props.permissionsCount
            }, null, _parent2, _scopeId));
            _push2(`</div>`);
            if (__props.permissionsCount && !__props.useServerProcessing) {
            ...
            if (__props.permissionsCount) {
              ...
              if (!__props.useServerProcessing) {
                ...
                _push2(ssrRenderComponent(_sfc_main$f, { pagination: __props.permissions }, null, _parent2, _scopeId));
              }
              _push2(`</div>`);
            } else {
              _push2(`<!---->`);
            ...
            if (viewMode.value === "table") {
              _push2(ssrRenderComponent(_sfc_main$2, {
                permissions: displayedPermissions.value,
            ...
            return [
              createVNode("div", { class: "px-2 py-2 w-full max-w-12xl mx-auto" }, [
                createVNode("div", { class: "p-4 bg-slate-50 dark:bg-slate-700 border border-blue-400 dark:border-blue-200 overflow-hidden shadow-md shadow-gray-500 dark:shadow-slate-400 bg-opacity-95 dark:bg-opacity-95" }, [
                  ...
                  __props.permissionsCount && !__props.useServerProcessing ? (openBlock(), createBlock(_sfc_main$8, {
                    key: 0,
                    modelValue: searchQuery.value,
                    "onUpdate:modelValue": ($event) => searchQuery.value = $event,
                    placeholder: unref(t)("searchByName")
                  }, null, 8, ["modelValue", "onUpdate:modelValue", "placeholder"])) : createCommentVNode("", true),
                  __props.permissionsCount && __props.useServerProcessing ? (openBlock(), createBlock(_sfc_main$9, {
                    key: 1,
                    modelValue: searchQuery.value,
                    "onUpdate:modelValue": ($event) => searchQuery.value = $event
                  ...
                  __props.permissionsCount ? (openBlock(), createBlock("div", {
                    ...
                    !__props.useServerProcessing ? (openBlock(), createBlock(_sfc_main$e, {
                      ...
                      key: 1,
                      pagination: __props.permissions
                    }, null, 8, ["pagination"]))
                  ])) : createCommentVNode("", true),
                  viewMode.value === "table" ? (openBlock(), createBlock(_sfc_main$2, {
                    ...
                    permissions: displayedPermissions.value,
                    onDelete: confirmDelete
                  }, null, 8, ["permissions"])) : (openBlock(), createBlock(_sfc_main$1, {
                    key: 6,
                    permissions: displayedPermissions.value,
                    onDelete: confirmDelete
                  }, null, 8, ["permissions"])),
...
_sfc_main.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("resources/js/Pages/Admin/System/Permissions/Index.vue");
