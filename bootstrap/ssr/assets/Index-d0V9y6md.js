...
_sfc_main$4.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("resources/js/Components/Admin/School/SchoolCoursePrice/Select/BulkActionSelect.vue");
...
_sfc_main$3.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("resources/js/Components/Admin/School/SchoolCoursePrice/Sort/SortSelect.vue");
  return _sfc_setup$3 ? _sfc_setup$3(props, ctx) : void 0;
};
const _sfc_main$2 = {
  __name: "CoursePriceTable",
  __ssrInlineRender: true,
  props: {
    prices: {
      type: Array,
  ...
  setup(__props, { emit: __emit }) {
    ...
    const getCourseTitle = (price) => {
      var _a, _b;
      return ((_b = (_a = price == null ? void 0 : price.course) == null ? void 0 : _a.translation) == null ? void 0 : _b.title) || `ID: ${(price == null ? void 0 : price.school_course_id) || "—"}`;
    };
    const getCourseSubtitle = (price) => {
      var _a, _b;
      return ((_b = (_a = price == null ? void 0 : price.course) == null ? void 0 : _a.translation) == null ? void 0 : _b.subtitle) || "";
    };
    const getCourseSlug = (price) => {
      var _a;
      return ((_a = price == null ? void 0 : price.course) == null ? void 0 : _a.slug) || "";
    };
          ...
          item: withCtx(({ element: price }, _push2, _parent2, _scopeId) => {
            if (_push2) {
              ...
              _push2(ssrRenderComponent(_sfc_main$6, {
                href: _ctx.route("admin.schoolCoursePrices.edit", {
                ...
                createVNode("tr", { class: "text-sm font-semibold border-b-2 hover:bg-slate-100 dark:hover:bg-cyan-800" }, [
                  ...
                  createVNode("td", { class: "px-2 py-3" }, [
                    createVNode("div", { class: "flex flex-col" }, [
                      ...
                      }, toDisplayString(getCourseTitle(price)), 9, ["title"]),
                      getCourseSubtitle(price) ? (openBlock(), createBlock("span", {
                        key: 0,
                        class: "text-[10px] text-slate-600 dark:text-slate-300"
                      }, toDisplayString(getCourseSubtitle(price)), 1)) : createCommentVNode("", true),
                      createVNode("span", { class: "text-[10px] text-slate-500 dark:text-slate-400" }, toDisplayString(getCourseSlug(price) || "—"), 1)
                    ])
                  ]),
                  createVNode("td", { class: "px-2 py-3 whitespace-nowrap text-center" }, [
                    createVNode("div", {
...
_sfc_main$2.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("resources/js/Components/Admin/School/SchoolCoursePrice/Table/CoursePriceTable.vue");
  return _sfc_setup$2 ? _sfc_setup$2(props, ctx) : void 0;
};
const _sfc_main$1 = {
  __name: "CoursePriceCardGrid",
  __ssrInlineRender: true,
  props: {
    prices: {
      type: Array,
  ...
  setup(__props, { emit: __emit }) {
    ...
    const getCourseShort = (price) => {
      var _a, _b;
      return ((_b = (_a = price == null ? void 0 : price.course) == null ? void 0 : _a.translation) == null ? void 0 : _b.short) || "";
    };
    const getCourseSlug = (price) => {
      var _a;
      return ((_a = price == null ? void 0 : price.course) == null ? void 0 : _a.slug) || "";
                ...
                createVNode("article", { class: "relative flex flex-col h-full rounded-md border border-slate-400 dark:border-slate-500 bg-slate-50/70 dark:bg-slate-800/80 shadow-sm hover:shadow-md transition-shadow duration-150" }, [
                  ...
                  createVNode("div", { class: "flex flex-col flex-1 px-3 py-2 space-y-2" }, [
                    createVNode("div", {
                      ...
                      createTextVNode(toDisplayString(getCourseTitle(price)) + " ", 1),
                      getCourseSubtitle(price) ? (openBlock(), createBlock("span", {
                        key: 0,
                        class: "block text-[10px] font-normal text-slate-600 dark:text-slate-300"
                      }, toDisplayString(getCourseSubtitle(price)), 1)) : createCommentVNode("", true),
                      getCourseSlug(price) ? (openBlock(), createBlock("span", {
                        key: 1,
                        class: "block text-[10px] font-normal text-gray-500 dark:text-gray-400"
                      }, toDisplayString(getCourseSlug(price)), 1)) : createCommentVNode("", true)
                    ], 8, ["title"]),
                    getCourseShort(price) ? (openBlock(), createBlock("div", {
                      key: 0,
                    ...
                    }, toDisplayString(getCourseShort(price)), 1)) : createCommentVNode("", true),
...
_sfc_main$1.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("resources/js/Components/Admin/School/SchoolCoursePrice/View/CoursePriceCardGrid.vue");
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    const props = __props;
    const viewMode = ref(
      localStorage.getItem("admin_view_mode_course_prices") || "table"
    );
    ...
    const itemsPerPage = ref(
      props.adminSchoolCoursePricesPerPage || 10
    );
    ...
    const sortParam = ref(
      props.sortParam || props.adminSchoolCoursePricesDefaultSort || "idDesc"
    );
    ...
    const getCourseTitle = (price) => {
      var _a2, _b;
      return ((_b = (_a2 = price == null ? void 0 : price.course) == null ? void 0 : _a2.translation) == null ? void 0 : _b.title) || `ID: ${(price == null ? void 0 : price.school_course_id) || ""}`;
    };
    const getCourseSubtitle = (price) => {
      var _a2, _b;
      return ((_b = (_a2 = price == null ? void 0 : price.course) == null ? void 0 : _a2.translation) == null ? void 0 : _b.subtitle) || "";
    };
    const getCourseShort = (price) => {
      var _a2, _b;
      return ((_b = (_a2 = price == null ? void 0 : price.course) == null ? void 0 : _a2.translation) == null ? void 0 : _b.short) || "";
    };
    const getCourseDescription = (price) => {
      var _a2, _b;
      return ((_b = (_a2 = price == null ? void 0 : price.course) == null ? void 0 : _a2.translation) == null ? void 0 : _b.description) || "";
    };
    const getCurrencyCode = (price) => {
      var _a2;
    ...
    const deleteCoursePrice = () => {
      ...
      router.delete(
        ...
        ),
        {
          ...
          onSuccess: () => {
            toast.success(
              `Цена курса "${titleToDelete || `ID: ${idToDelete}`}" удалена.`
            );
          },
          onError: (errors) => {
            ...
            const errorMsg = (errors == null ? void 0 : errors.general) || (errors == null ? void 0 : errors[firstKey]) || "Ошибка при удалении цены курса.";
            toast.error(
    ...
    const bulkDestroy = () => {
      ...
      router.delete(
        ...
        ),
        {
          ...
          onError: (errors) => {
            toast.error(
              (errors == null ? void 0 : errors.ids) || (errors == null ? void 0 : errors.general) || "Не удалось массово удалить цены курсов"
            );
          }
        }
      );
      ...
      router.put(
        ...
        },
        {
          ...
          onSuccess: () => {
            ...
            toast.success(
              `Цена курса "${getDeleteTitle(price) || `ID: ${price.id}`}" ${actionText}.`
            );
          },
          onError: (errors) => {
            toast.error(
      ...
      router.put(
        ...
        },
        {
          ...
          onError: (errors) => {
            ...
            toast.error(
              (errors == null ? void 0 : errors.items) || (errors == null ? void 0 : errors.general) || "Не удалось обновить порядок цен курсов."
            );
            router.reload({
              only: [
                "prices"
          ...
          if (_push2) {
            _push2(ssrRenderComponent(TitlePage, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`${ssrInterpolate(unref(t)("coursePrices"))}`);
                } else {
                  return [
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(ssrRenderComponent(_sfc_main$8, {
              href: _ctx.route("admin.schoolCoursePrices.create")
            }, {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(` ${ssrInterpolate(unref(t)("addCoursePrice"))}`);
                } else {
                  return [
                    createTextVNode(" " + toDisplayString(unref(t)("addCoursePrice")), 1)
                  ];
                }
              }),
              _: 1
            ...
            _push2(ssrRenderComponent(_sfc_main$9, {
              ...
              mode: __props.adminSchoolCoursePricesProcessingMode,
...
_sfc_main.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("resources/js/Pages/Admin/School/SchoolCoursePrices/Index.vue");
