  ...
  setup(__props, { emit: __emit }) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      ssrRenderList(__props.options, (option) => {
        ...
        })}">${ssrInterpolate(option.name)}</option>`);
      });
      _push(`<!--]--></select>`);
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("resources/js/Components/Admin/School/SchoolTrack/Select/SelectParentTrack.vue");
