...
import { _ as _sfc_main$2 } from "./ActionMessage-DC25KQer.js";
import { _ as _sfc_main$7 } from "./Modal-DV5F1V7t.js";
import { _ as _sfc_main$a } from "./ConfirmationModal-RvAlhLPy.js";
import { _ as _sfc_main$b } from "./DangerButton-CnCACk3P.js";
import { _ as _sfc_main$8 } from "./DialogModal-qFgExXTx.js";
import { _ as _sfc_main$1 } from "./FormSection-T33_rrjA.js";
import { _ as _sfc_main$5, a as _sfc_main$6 } from "./TextInput-CCxUFX3K.js";
import { _ as _sfc_main$4 } from "./InputLabel-Ds0Eo91B.js";
import { _ as _sfc_main$3 } from "./PrimaryButton-D7EZDGT_.js";
import { _ as _sfc_main$9 } from "./SecondaryButton-05lGdtfU.js";
      ...
      if (__props.userPermissions.canAddTeamMembers) {
        ...
        _push(ssrRenderComponent(_sfc_main$1, { onSubmitted: addTeamMember }, {
          ...
          form: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(`<div class="col-span-6"${_scopeId}><div class="max-w-xl font-semibold text-sm text-indigo-800 dark:text-slate-300"${_scopeId}>${ssrInterpolate(unref(t)("addTeamMemberEmailPrompt"))}</div></div><div class="col-span-6 sm:col-span-4"${_scopeId}>`);
              ...
              if (__props.availableRoles.length > 0) {
                ...
                ssrRenderList(__props.availableRoles, (role, i) => {
                  ...
                  })}"${_scopeId}><div class="flex items-center"${_scopeId}><div class="${ssrRenderClass([{ "font-semibold": unref(addTeamMemberForm).role == role.key }, "font-semibold text-md text-pink-400"])}"${_scopeId}>${ssrInterpolate(role.name)}</div>`);
                  ...
                  _push2(`</div><div class="mt-2 italic text-sm text-gray-900 dark:text-slate-50 text-start"${_scopeId}>${ssrInterpolate(role.description)}</div></div></button>`);
                });
                _push2(`<!--]--></div></div>`);
              } else {
                _push2(`<!---->`);
              ...
              return [
                createVNode("div", { class: "col-span-6" }, [
                  createVNode("div", { class: "max-w-xl font-semibold text-sm text-indigo-800 dark:text-slate-300" }, toDisplayString(unref(t)("addTeamMemberEmailPrompt")), 1)
                ]),
                      ...
                      return openBlock(), createBlock("button", {
                        ...
                        createVNode("div", {
                          ...
                          createVNode("div", { class: "flex items-center" }, [
                            createVNode("div", {
                              class: ["font-semibold text-md text-pink-400", { "font-semibold": unref(addTeamMemberForm).role == role.key }]
                          ...
                          createVNode("div", { class: "mt-2 italic text-sm text-gray-900 dark:text-slate-50 text-start" }, toDisplayString(role.description), 1)
                        ], 2)
                      ], 10, ["onClick"]);
                    }), 128))
                  ])
