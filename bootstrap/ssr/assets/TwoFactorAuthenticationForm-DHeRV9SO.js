...
import { _ as _sfc_main$7 } from "./Modal-DV5F1V7t.js";
import { useI18n } from "vue-i18n";
import { _ as _sfc_main$2 } from "./DialogModal-qFgExXTx.js";
import { _ as _sfc_main$5, a as _sfc_main$6 } from "./TextInput-CCxUFX3K.js";
import { _ as _sfc_main$4 } from "./PrimaryButton-D7EZDGT_.js";
import { _ as _sfc_main$3 } from "./SecondaryButton-05lGdtfU.js";
import { _ as _sfc_main$9 } from "./DangerButton-CnCACk3P.js";
import { _ as _sfc_main$8 } from "./InputLabel-Ds0Eo91B.js";
...
_sfc_main$1.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("resources/js/Components/Base/ConfirmsPassword.vue");
        ...
        content: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            if (twoFactorEnabled.value && !confirming.value) {
              _push2(`<h3 class="text-md font-medium text-orange-400 dark:text-orange-200"${_scopeId}>${ssrInterpolate(unref(t)("twoFactorEnabled"))}</h3>`);
            } else if (twoFactorEnabled.value && confirming.value) {
              _push2(`<h3 class="text-md font-medium text-orange-400 dark:text-orange-200"${_scopeId}>${ssrInterpolate(unref(t)("completeTwoFactorSetup"))}</h3>`);
            } else {
              _push2(`<h3 class="text-md font-medium text-orange-400 dark:text-orange-200"${_scopeId}>${ssrInterpolate(unref(t)("twoFactorNotEnabled"))}</h3>`);
            }
            _push2(`<div class="mt-3 max-w-xl font-semibold text-sm text-indigo-900 dark:text-sky-200"${_scopeId}><p${_scopeId}>${ssrInterpolate(unref(t)("twoFactorExplanation"))}</p></div>`);
            if (twoFactorEnabled.value) {
              _push2(`<div${_scopeId}>`);
              if (qrCode.value) {
                _push2(`<div${_scopeId}><div class="mt-4 max-w-xl font-semibold text-sm text-indigo-900 dark:text-sky-200"${_scopeId}>`);
                if (confirming.value) {
                ...
                if (setupKey.value) {
                  _push2(`<div class="mt-4 max-w-xl text-sm text-orange-500"${_scopeId}><p class="font-semibold"${_scopeId}>${ssrInterpolate(unref(t)("setupKey"))}: <span${_scopeId}>${setupKey.value ?? ""}</span></p></div>`);
                } else {
                  _push2(`<!---->`);
                }
                if (confirming.value) {
              ...
              if (recoveryCodes.value.length > 0 && !confirming.value) {
                _push2(`<div${_scopeId}><div class="mt-4 max-w-xl text-sm text-indigo-900 dark:text-sky-200"${_scopeId}><p class="font-semibold"${_scopeId}>${ssrInterpolate(unref(t)("recoveryCodesMessage"))}</p></div><div class="grid gap-1 max-w-xl mt-4 px-4 py-4 font-mono text-sm bg-gray-100 rounded-lg"${_scopeId}><!--[-->`);
            ...
            return [
              ...
              createVNode("div", { class: "mt-3 max-w-xl font-semibold text-sm text-indigo-900 dark:text-sky-200" }, [
              ...
              twoFactorEnabled.value ? (openBlock(), createBlock("div", { key: 3 }, [
                qrCode.value ? (openBlock(), createBlock("div", { key: 0 }, [
                  createVNode("div", { class: "mt-4 max-w-xl font-semibold text-sm text-indigo-900 dark:text-sky-200" }, [
                  ...
                  setupKey.value ? (openBlock(), createBlock("div", {
                    key: 0,
                    class: "mt-4 max-w-xl text-sm text-orange-500"
                  }, [
                ...
                recoveryCodes.value.length > 0 && !confirming.value ? (openBlock(), createBlock("div", { key: 1 }, [
                  createVNode("div", { class: "mt-4 max-w-xl text-sm text-indigo-900 dark:text-sky-200" }, [
