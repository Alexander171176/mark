...
return new class extends Migration
{
    ...
    {
        Schema::create('school_bundle_prices', function (Blueprint $t) {
            $t->id();
            ...
            $t->index(
                ['school_bundle_id', 'currency_id', 'activity'],
                'idx_school_bundle_price_currency_active'
            );

            $t->index(
                ['activity', 'sort'],
                'idx_school_bundle_price_active_sort'
            );

            $t->index(
                ['school_bundle_id', 'currency_id', 'starts_at', 'ends_at'],
                'idx_school_bundle_price_period'
            );
        });
    }
    ...
    {
        Schema::dropIfExists('school_bundle_prices');
    }
};
