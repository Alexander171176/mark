...
SVG;
        ...
        DB::table('hero_icons')->upsert(
            $rows,
            ['hero_section_id', 'label'],
            ['svg', 'sort', 'activity', 'updated_at']
        );
    }
}
