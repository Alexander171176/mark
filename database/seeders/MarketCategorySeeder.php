    ...
    public function run(): void
    {
        DB::transaction(function () {
            ...
            /*
             ...
             |--------------------------------------------------------------------------
             */
            $smartphones = $this->createCategory($userId, $electronics->id, 2, 10, '+', 'smartphones', 180, [
            ...
            $laptops = $this->createCategory($userId, $electronics->id, 2, 20, '+', 'laptops', 170, [
            ...
            $furniture = $this->createCategory($userId, $home->id, 2, 10, '+', 'furniture', 130, [
            ...
            $kitchen = $this->createCategory($userId, $home->id, 2, 20, '+', 'kitchen-products', 115, [
            ...
            $mensClothing = $this->createCategory($userId, $fashion->id, 2, 10, '+', 'mens-clothing', 150, [
            ...
            $womensClothing = $this->createCategory($userId, $fashion->id, 2, 20, '+', 'womens-clothing', 155, [
            ...
            $cosmetics = $this->createCategory($userId, $beauty->id, 2, 10, '+', 'cosmetics', 100, [
            ...
            $carAccessories = $this->createCategory($userId, $auto->id, 2, 10, '+', 'car-accessories', 90, [
            ...
            /*
             ...
             |--------------------------------------------------------------------------
             */
            $this->createCategory($userId, $smartphones->id, 3, 10, '+', 'apple-iphone', 95, [
            ...
            $this->createCategory($userId, $smartphones->id, 3, 20, '+', 'android-smartphones', 105, [
            ...
            $this->createCategory($userId, $laptops->id, 3, 10, '+', 'business-laptops', 88, [
            ...
            $this->createCategory($userId, $furniture->id, 3, 10, '+', 'bedroom-furniture', 75, [
