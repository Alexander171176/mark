    ...
    public function run(): void
    {
        $settings = [
            ...
            [
                ...
                'activity' => true,
                'sort' => 0,
            ], // PUBLIC MARKET COMPANIES VIEW
            [
                'type' => 'string',
                'option' => 'adminMarketStorefrontsProcessingMode',
                'value' => 'auto',
                'constant' => 'ADMIN_MARKET_STOREFRONTS_PROCESSING_MODE',
                'category' => 'admin',
                'description' => 'Режим обработки данных витрин в административной части: frontend / server / auto',
                'activity' => true,
                'sort' => 0,
            ], // ADMIN MARKET STOREFRONTS PROCESSING MODE
            [
                'type' => 'string',
                'option' => 'publicMarketStorefrontsProcessingMode',
                'value' => 'auto',
                'constant' => 'PUBLIC_MARKET_STOREFRONTS_PROCESSING_MODE',
                'category' => 'public',
                'description' => 'Режим обработки данных витрин в публичной части: frontend / server / auto',
                'activity' => true,
                'sort' => 0,
            ], // PUBLIC MARKET STOREFRONTS PROCESSING MODE
            [
                'type' => 'number',
                ...
                'activity' => true,
                'sort' => 0,
            ], // ADMIN MARKET STOREFRONTS PER PAGE
            [
                'type' => 'number',
                ...
                'activity' => true,
                'sort' => 0,
            ], // PUBLIC MARKET STOREFRONTS PER PAGE
            [
                'type' => 'string',
                ...
                'activity' => true,
                'sort' => 0,
            ], // ADMIN MARKET STOREFRONTS DEFAULT SORT
            [
                'type' => 'string',
                ...
                'activity' => true,
                'sort' => 0,
            ], // PUBLIC MARKET STOREFRONTS DEFAULT SORT
            [
                'type' => 'string',
                'option' => 'adminMarketStorefrontsDefaultView',
                'value' => 'grid',
                'constant' => 'ADMIN_MARKET_STOREFRONTS_DEFAULT_VIEW',
                'category' => 'admin',
                'description' => 'Вид списка витрин компаний в панели администратора',
                'activity' => true,
                'sort' => 0,
            ], // ADMIN MARKET STOREFRONTS VIEW
            [
                'type' => 'string',
                'option' => 'publicMarketStorefrontsDefaultView',
                'value' => 'grid',
                'constant' => 'PUBLIC_MARKET_STOREFRONTS_DEFAULT_VIEW',
                'category' => 'public',
                'description' => 'Вид списка витрин компаний в публичной части',
                'activity' => true,
                'sort' => 0,
            ], // PUBLIC MARKET STOREFRONTS VIEW
