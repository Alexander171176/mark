...
<template>
    <div class="bg-white dark:bg-slate-700 shadow-lg rounded-sm
        ...
        <!-- Верхняя панель: выбранные + selectAll -->
        <div
        ...
        <div class="overflow-x-auto">
            <table v-if="articles.length > 0"
                ...
                <tr>
                    ...
                    <th class="px-1 first:pl-11 last:pr-11 py-3 whitespace-nowrap w-px">
                        <div class="font-medium text-center">{{ t('id') }}</div>
                    </th>
                    <th class="px-1 first:pl-11 last:pr-11 py-3 whitespace-nowrap">
                ...
                >
                    <template #item="{ element: article }">
                        <tr class="text-sm font-semibold border-b-2
                            ...
                            <td class="px-1 py-1 text-center cursor-move handle">
                            ...
                            <td class="first:pl-11 last:pr-11 whitespace-nowrap">
                                <div
                          ...
                          : 'bg-gray-100 dark:bg-gray-900 text-gray-900 dark:text-gray-100'"
                            ...
                            <td class="px-1 first:pl-11 last:pr-11 py-1 whitespace-nowrap">
                                <div class="text-left">
                                    <a :href="`/blog/articles/${encodeURIComponent(article.url)}`"
                            ...
                            <td class="px-1 first:pl-11 last:pr-11 py-1 whitespace-nowrap">
                                <div class="flex justify-center space-x-1">
                                    <ActivityToggle :isActive="article.activity"
                                                    @toggle-activity="$emit('toggle-activity',
                                                    article)"
