...
<template>
    <div class="flex justify-center items-center h-fit mt-2 mb-2">
        ...
        >
            ...
            <option value="privateDesc">{{ t('private') }} ON→OFF</option>
            <option value="privateAsc">{{ t('private') }} OFF→ON</option>
            <option disabled>─────────────────</option>
            ...
            <option value="sourceTypeAsc">{{ t('source') }} A→Z</option>
            <option value="sourceTypeDesc">{{ t('source') }} Z→A</option>
            ...
            <option value="articlesDesc">{{ t('articles') }} 9→0</option>
            <option value="articlesAsc">{{ t('articles') }} 0→9</option>

            <option value="relatedVideosDesc">{{ t('relatedVideos') }} 9→0</option>
            <option value="relatedVideosAsc">{{ t('relatedVideos') }} 0→9</option>
            <option disabled>─────────────────</option>
