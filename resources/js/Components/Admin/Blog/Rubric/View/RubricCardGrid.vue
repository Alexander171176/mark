...
const getTitle = (rubric) => {
    return getTranslation(rubric)?.title || `ID: ${rubric?.id}`
}
                            ...
                            <div class="flex items-center justify-center text-center">
                                <div class="flex items-center justify-center space-x-2 max-w-full">
                                    <div class="flex items-center justify-center shrink-0">
                                        ...
                                        <div
                                            v-if="getSafeIcon(rubric.icon)"
                                            v-html="getSafeIcon(rubric.icon)"
                                    ...
                                    <a
                                        ...
                                        :title="getTitle(rubric)"
                                    >
                                        {{ truncateText(getTitle(rubric)) }}
                                    </a>
