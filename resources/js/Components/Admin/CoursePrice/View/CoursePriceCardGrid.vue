...
const courseTitle = (p) => p?.course?.title || '—'
const courseSlug = (p) => p?.course?.slug || ''
            ...
            >
                <template #item="{ element: p }">
                    ...
                    >
                        <!-- Верх карточки -->
                        <div
                            class="flex items-center justify-between px-2 py-1 border-b border-dashed border-slate-400 dark:border-slate-500">
                        ...
                        <div class="flex flex-col flex-1 px-3 py-2 space-y-2">
                            ...
                            <a
                                v-if="courseSlug(p)"
                                :href="`/courses/${encodeURIComponent(courseSlug(p))}`"
                                target="_blank"
                        ...
                        <!-- Действия -->
                        <div
                            class="flex items-center justify-center px-3 py-2 border-t border-dashed border-slate-400 dark:border-slate-500">
