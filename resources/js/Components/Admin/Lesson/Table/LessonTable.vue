...
// 🔹 Мапы "значение из БД" → "ключ перевода" (flat i18n) для уроков
        ...
        <div class="overflow-x-auto">
            <table
                ...
                <tr>
                    ...
                    <th class="px-2 py-3 first:pl-12 last:pr-12 whitespace-nowrap">
                        <div class="flex justify-center" :title="t('difficulty')">
                            <svg
                                xmlns="http://www.w3.org/2000/svg"
                ...
                >
                    <template #item="{ element: lesson }">
                        <tr
                            ...
                            <td class="px-2 py-3 first:pl-12 last:pr-12 whitespace-nowrap">
                                <div class="flex justify-center"
                                    ...
                                    <template
                                        ...
                                        <img
                                            :src="getPrimaryImage(lesson).webp_url ||
                                            getPrimaryImage(lesson).url"
                                            :alt="getPrimaryImage(lesson).alt ||
                                                t('defaultImageAlt')"
                                            :title="
                                                getPrimaryImage(lesson).caption ||
                                                t('lessonImage')"
                                            class="h-12 w-16 object-cover rounded-xs"
                                        />
                                    </template>
                                    <template v-else>
                                        <img
                            ...
                            <td class="px-2 py-3 first:pl-12 last:pr-12 whitespace-nowrap">
                                <div class="flex flex-col gap-0.5 text-xs text-left">

                                    <!-- УРОК -->
                                    <a
                                        :href="`/school/lessons/${encodeURIComponent(lesson.slug)}`"
                                        class="font-semibold text-sky-600 dark:text-sky-200
                                               hover:underline"
                                        target="_blank"
                        ...
                        :title="`${t('status')} : ${getLessonStatusLabel(lesson.status)} / `
                        + `${t('accessType')} : ${getLessonAccessTypeLabel(lesson.access_type)} / `
                        + `${t('previewMode')} : ${getLessonPreviewModeLabel(lesson.preview_mode)}`"
                                >
                            ...
                            <td class="px-2 py-3 first:pl-12 last:pr-12 whitespace-nowrap">
                                <div class="text-center text-xs
                                     ...
                                     :title="`${t('duration')} [${lesson.duration}]`">
                                    {{ lesson.duration }}
                                </div>
                            </td>
                            <td class="px-2 py-3 first:pl-12 last:pr-12 whitespace-nowrap">
