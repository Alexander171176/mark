...
<template>
    ...
    <SidebarLink :href="route('admin.home-page.index')"
    ...
    <SidebarLink :href="route('admin.orders.index')"
    ...
    <SidebarLink :href="route('admin.instructorProfiles.index')"
                 :active="route().current('instructorProfiles.index')"
                 :expanded="props.expanded">
        <template #default>
            <svg class="shrink-0 h-6 w-6" viewBox="0 0 24 24">
                <path class="fill-current text-blue-600"
    ...
    <SidebarLink :href="route('admin.hashtags.index')"
                 :active="route().current('hashtags.index')"
                 :expanded="props.expanded">
        <template #default>
            <svg class="shrink-0 h-6 w-6" viewBox="0 0 24 24">
                <path class="fill-current text-blue-600"
    ...
    <SidebarLink :href="route('admin.learningCategories.index')"
                 :active="route().current('learningCategories.index')"
                 :expanded="props.expanded">
        <template #default>
            <svg class="shrink-0 h-6 w-6" viewBox="0 0 24 24">
                <path class="fill-current text-blue-600"
    ...
    <SidebarLink :href="route('admin.courses.index')"
    ...
    <SidebarLink :href="route('admin.modules.index')"
    ...
    <SidebarLink :href="route('admin.lessons.index')"
    ...
    <SidebarLink :href="route('admin.assignments.index')"
    ...
    <SidebarLink :href="route('admin.courseSchedules.index')"
                 :active="route().current('courseSchedules.index')"
                 :expanded="props.expanded">
        <template #default>
            <svg class="shrink-0 h-6 w-6" viewBox="0 0 24 24">
                <path class="fill-current text-blue-600"
    ...
    <SidebarLink :href="route('admin.cohortEnrollments.index')"
                 :active="route().current('cohortEnrollments.index')"
                 :expanded="props.expanded">
        <template #default>
            <svg class="shrink-0 h-6 w-6" viewBox="0 0 24 24">
                <path class="fill-current text-blue-600"
    ...
    <SidebarLink :href="route('admin.enrollments.index')"
    ...
    <SidebarLink :href="route('admin.quizzes.index')"
    ...
    <SidebarLink :href="route('admin.quizQuestions.index')"
                 :active="route().current('quizQuestions.index')"
                 :expanded="props.expanded">
        <template #default>
            <svg class="shrink-0 h-6 w-6" viewBox="0 0 24 24">
                <path class="fill-current text-blue-600"
    ...
    <SidebarLink :href="route('admin.quizAnswers.index')"
                 :active="route().current('quizAnswers.index')"
                 :expanded="props.expanded">
        <template #default>
            <svg class="shrink-0 h-6 w-6" viewBox="0 0 24 24">
                <path class="fill-current text-blue-600"
