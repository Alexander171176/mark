...
<template>
    ...
    >
        ...
        <div v-if="localGroups.length" class="p-3">
            <draggable
                tag="div"
                v-model="localGroups"
                item-key="id"
                ...
                <template #item="{ element: group }">
                    ...
                    >
                            ...
                            <div class="flex items-center space-x-2">
                                ...
                                >
                                    <svg
                                        ...
                                        :class="{ 'rotate-180': isOwnerBlockOpen(group.id) }"
                                        fill="currentColor"
                                        viewBox="0 0 20 20"
                                    >
                                        <path
                        ...
                        <div class="flex flex-col flex-1 px-3 py-2 space-y-2">
                            <div
                                v-show="isOwnerBlockOpen(group.id)"
                            ...
                            <div class="text-center text-xs text-slate-500 dark:text-slate-400">
                                {{ t('code') }}: {{ truncateText(group.code, 90) }}
                            </div>
                            ...
                            <div
                                v-if="groupShort(group)"
                                class="font-semibold text-[12px] text-center
                                       text-cyan-700 dark:text-cyan-300"
                            >
                                {{ truncateText(groupShort(group), 120) }}
                            </div>
