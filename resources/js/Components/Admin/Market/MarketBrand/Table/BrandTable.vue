...
/** Локальная копия брендов для drag&drop */
...
/** Все отображаемые бренды выбраны */
const allSelected = () => {
    return Boolean(
            ...
            >
                ...
                >
                    <template #item="{ element: brand }">
                        ...
                        >
                            <td
                                class="px-1 py-1 text-center cursor-move handle w-px"
                            >
                                <svg
                            ...
                            <td class="px-1 py-1">
                                <div class="text-left">
                                    ...
                                    <div
                                        class="text-[10px] text-fuchsia-700 dark:text-fuchsia-300"
                                    >
                            ...
                            <td class="px-1 py-1 whitespace-nowrap">
                                <div class="flex items-center justify-center gap-1">
                                    ...
                                    <ModerationButton
                                        ...
                                        mode="toggle"
                                        @submit="({ status, note }) => emitApprove(brand, status, note)"
                                    />
                                </div>
                            </td>
