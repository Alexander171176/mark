...
<template>
    <div class="flex justify-center items-center h-fit mt-2 mb-2">
        ...
        >
            ...
            <option value="legalNameAsc">{{ t('legalName') }} A→Z</option>
            <option value="legalNameDesc">{{ t('legalName') }} Z→A</option>

            <option value="companyTypeAsc">{{ t('type') }} A→Z</option>
            <option value="companyTypeDesc">{{ t('type') }} Z→A</option>

            <option value="cityAsc">{{ t('city') }} A→Z</option>
            <option value="cityDesc">{{ t('city') }} Z→A</option>
            <option disabled>───────────────────────────</option>
