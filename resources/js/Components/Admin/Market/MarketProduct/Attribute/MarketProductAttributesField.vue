...
const normalizeRow = (item = {}, order = 0) => ({
    ...
    value_date: item?.value_date
        ? String(item.value_date).slice(0, 10)
        : '',
...
/**
 * Значения характеристики берём только из attributes[].values.
 * Отдельный справочник attributeValues больше не нужен.
 */
                ...
                <div class="grid grid-cols-1 gap-3 lg:grid-cols-2">
                    ...
                    <div class="flex items-end justify-between gap-3">
                        ...
                        <button type="button"
                            ...
                            <svg class="w-3 h-3 fill-current" viewBox="0 0 448 512">
                                <path
