...
<template>
    <div class="flex justify-center items-center h-fit mt-2 mb-2">
        ...
        >
            ...
            <option value="phoneAsc">{{ t('phone') }} A→Z</option>
            <option value="phoneDesc">{{ t('phone') }} Z→A</option>
            <option disabled>────────────────────</option>
            ...
            <option value="companyLegalNameAsc">{{ t('company') }} A→Z</option>
            <option value="companyLegalNameDesc">{{ t('company') }} Z→A</option>
            <option disabled>────────────────────</option>
            ...
            <option value="showFromAtDesc">
                {{ t('show') }} - {{ t('shortStarted') }} ↓
            </option>
            <option value="showFromAtAsc">
                {{ t('show') }} - {{ t('shortStarted') }} ↑
            </option>

            <option value="showToAtDesc">
                {{ t('show') }} - {{ t('shortExpires') }} ↓
            </option>
            <option value="showToAtAsc">
                {{ t('show') }} - {{ t('shortExpires') }} ↑
            </option>
