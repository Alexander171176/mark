...
const isOwnerBlockOpen = (tagId) => {
    return openedOwnerBlocks.value.includes(tagId)
}

const toggleOwnerBlock = (tagId) => {
    if (isOwnerBlockOpen(tagId)) {
        openedOwnerBlocks.value = openedOwnerBlocks.value.filter(id => id !== tagId)
        return
    }

    openedOwnerBlocks.value.push(tagId)
}
</script>
                    ...
                    >
                        ...
                        >
                            <div class="flex items-center space-x-2">
                                ...
                                <button
                                    ...
                                    :title="isOwnerBlockOpen(tag.id) ? t('hideOwner') : t('showOwner')"
                        ...
                        >
                            <div class="flex items-center space-x-1">
                                ...
                                <DeleteIconButton @delete="$emit('delete', tag)" />
                            </div>
                        </div>
                    </div>
                </template>
