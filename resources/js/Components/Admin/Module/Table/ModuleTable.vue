...
// 🔹 Мапы "значение из БД" → "ключ перевода" (используем те же, что и в курсах)
...
const getModuleStatusLabel = (status) => {
    return t(moduleStatusLabelKeyMap[status] || status || '—')
}

const getModuleAvailabilityLabel = (availability) => {
    return t(moduleAvailabilityLabelKeyMap[availability] || availability || '—')
}
                ...
                <tr>
                    ...
                    <th class="px-2 py-3 first:pl-14 last:pr-14 whitespace-nowrap">
                        <div class="flex justify-center" :title="t('lessonsCount')">
                            <svg class="w-4 h-3 fill-slate-400" viewBox="0 0 16 12">
                                <path class="fill-current text-teal-600 dark:text-teal-300"
                                    d="m16 2-4 2.4V2a2 2 0 0 0-2-2H2a2 2 0 0 0-2 2v8a2 2 0 0 0 2 2h8a2 2 0 0 0 2-2V7.6l4 2.4V2ZM2 10V2h8v8H2Z"></path>
                            </svg>
                        </div>
                    </th>
                    <th class="px-2 py-3 first:pl-14 last:pr-14 whitespace-nowrap">
                ...
                >
                    <template #item="{ element: module }">
                        <tr
                            ...
                            <td class="px-2 py-3 first:pl-14 last:pr-14 whitespace-nowrap">
                                <div class="flex justify-center">
                                    <template
                                        ...
                                        <img
                                            :src="getPrimaryImage(module).webp_url ||
                                            getPrimaryImage(module).url"
                                            :alt="getPrimaryImage(module).alt ||
                                                t('defaultImageAlt')"
                                            :title="
                                                getPrimaryImage(module).caption ||
                                                t('moduleImage')"
                            ...
                            <td class="px-2 py-3 first:pl-14 last:pr-14 whitespace-nowrap">
                                <div class="min-w-0">
                                    <div class="text-xs text-teal-600 dark:text-teal-200"
                                         :title="`ID: ${module.course.id}`">
                                        {{ module.course.title }}
                                    </div>
                                    <a
                                        ...
                                        target="_blank"
                                        rel="noopener noreferrer" :title="module.subtitle">
                                        {{ module.title }}
                                    </a>
                                </div>
                            </td>
                            ...
                            <td class="px-2 py-3 first:pl-14 last:pr-14 whitespace-nowrap">
                                <div class="text-center text-xs
                                     ...
                                     :title="`${t('duration')} [${module.duration}]`">
                                    {{ module.duration }}
                                </div>
                            </td>
                            <td class="px-2 py-3 first:pl-14 last:pr-14 whitespace-nowrap">
