...
<template>
    <div
        class="relative bg-white dark:bg-slate-700 shadow-lg rounded-sm
            ...
            >
                ...
                >
                            ...
                            <div class="flex flex-wrap items-center gap-2 mb-1">
                                    <span
                                        class="inline-flex items-center rounded-sm
                                               ...
                                               px-2 py-0.5 text-xs font-bold text-amber-700
                                               dark:bg-amber-900/40 dark:text-amber-300"
                                    >
                                ...
                                <span
                                    class="inline-flex items-center rounded-sm border
                    ...
                    <td class="px-2 first:pl-5 last:pr-5 py-2">
                        ...
                        >
                            <span>{{ getReviewableType(review) }}</span>
                        ...
                        <div
                            ...
                            :title="getReviewableTitle(review)"
                        >
