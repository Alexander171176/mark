                                ...
                                <div class="flex flex-row items-center space-x-7">
                                    <div class="flex flex-row items-center space-x-1">
                                        <LeftToggle
                                            ...
                                            @toggle-left="$emit('toggle-left', course)"
                                            :title="course.left ? t('enabled') : t('disabled')"
                                        />
                                        <MainToggle
                                            :isActive="course.main"
                                            @toggle-main="$emit('toggle-main', course)"
                                            :title="course.main ? t('enabled') : t('disabled')"
                                        />
                                        <RightToggle
                                            :isActive="course.right"
                                            @toggle-right="$emit('toggle-right', course)"
                                            :title="course.right ? t('enabled') : t('disabled')"
                                        />
                                    </div>
                                    <div class="flex flex-row items-center space-x-1">
                                        <NewButtonToggle
                                            :isActive="course.is_new"
                                            @toggle-is-new="$emit('toggle-is-new', course)"
                                            :title="course.is_new ? t('enabled') : t('disabled')"
                                        />
                                        <HitButtonToggle
                                            :isActive="course.is_hit"
                                            @toggle-is-hit="$emit('toggle-is-hit', course)"
                                            :title="course.is_hit ? t('enabled') : t('disabled')"
                                        />
                                        <SaleButtonToggle
                                            :isActive="course.is_sale"
                                            @toggle-is-sale="$emit('toggle-is-sale', course)"
                                            :title="course.is_sale ? t('enabled') : t('disabled')"
                                        />
                                    </div>
                                </div>
                                <div class="flex flex-row items-center space-x-1">
                                    ...
                                    />
                                    <IconEdit
                                        :href="route('admin.schoolCourses.edit', { schoolCourse: course.id })"
                                    />
                                    <DeleteIconButton
