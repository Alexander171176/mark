        ...
        <div class="overflow-x-auto">
            ...
            >
                ...
                <tr>
                    ...
                    <th class="font-medium px-2 py-3 whitespace-nowrap text-left">
                        {{ t('question') }}
                    </th>
                ...
                >
                    <template #item="{ element: question }">
                        ...
                        >
                            ...
                            >
                                {{ question.quiz?.title || ('#' + question.school_quiz_id) }}
                            </td>

                            <td class="px-2 py-3 text-xs min-w-72">
                                <div
                            ...
                            <td
                                class="px-2 py-3 text-center text-xs"
                            >
                                <div class="text-fuchsia-700 dark:text-fuchsia-200">
