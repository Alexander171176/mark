        ...
        <div class="overflow-x-auto">
            ...
            >
                ...
                <tr>
                    ...
                    <th class="px-2 py-3 whitespace-nowrap">
                        <div class="font-semibold text-left">{{ t('lesson') }}</div>
                    </th>
                    <th class="px-2 py-3 whitespace-nowrap">
                ...
                >
                    <template #item="{ element: lesson }">
                        ...
                        >
                            ...
                            <td class="px-2 py-3 whitespace-nowrap">
                                <div class="flex justify-center" :title="lesson.title || ''">
                        <img
                            ...
                            <td class="px-2 py-3 whitespace-nowrap">
                                <div class="min-w-0">
                                    <a
                                        ...
                                        :title="lesson.subtitle || lesson.short"
                                    >
                    ...
                    <svg class="shrink-0 h-3 w-3" viewBox="0 0 24 24">
                        <rect class="fill-current text-cyan-600" x="1" y="1" width="10" height="10"
                              rx="2"></rect>
                        ...
                        <rect class="fill-current text-cyan-600" x="13" y="13" width="10"
                              height="10" rx="2"></rect>
                        <rect class="fill-current text-cyan-600" x="1" y="13" width="10" height="10"
                              rx="2"></rect>
                    </svg>
                                        <span>{{ getModuleTitle(lesson) }}</span>
                                    </div>
                                    <div class="flex flex-row items-center gap-1
                                                text-xs text-slate-700 dark:text-slate-200">
                                        <svg class="shrink-0 h-3 w-3" viewBox="0 0 448 512">
                                            <path class="fill-current text-cyan-500"
                                        ...
                                        <span>{{ getCourseTitle(lesson) }}</span>
                                    </div>
                                </div>
                            </td>
                            <td class="px-2 py-3 whitespace-nowrap">
                            ...
                            <td class="px-2 py-3 whitespace-nowrap">
                                ...
                                <div class="text-center text-[10px]
                                            text-slate-500 dark:text-slate-300">
                                    {{ t('difficulty') }}: {{ lesson.difficulty ?? 0 }}
                                </div>
                            </td>
                            <td class="px-2 py-3 whitespace-nowrap">
                                <div class="text-center text-xs
