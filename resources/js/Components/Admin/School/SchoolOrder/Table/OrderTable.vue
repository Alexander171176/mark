            ...
            >
                ...
                >
                    ...
                    <td class="px-2 py-3 whitespace-nowrap text-slate-800 dark:text-slate-100">
                        ...
                        <div v-if="!getBuyerEmail(order) && !order.buyer_phone">
                            —
                        </div>
                    </td>
                    <td class="px-2 py-3">
                        ...
                        <div v-if="!order.course?.title && !order.schedule?.title">
                            —
                        </div>
                    </td>
                    ...
                    <td class="px-2 py-3 text-blue-800 dark:text-blue-200">
                        ...
                        >
                            {{ t('paidAt') }}: {{ formatDateTime(order.paid_at) }}
                        </div>
                    </td>
                    <td class="px-2 py-3 whitespace-nowrap">
                        <div class="flex flex-col gap-1">
                            <span
                                :class="[
                                    'inline-flex w-fit items-center rounded-sm px-2 py-0.5 ' +
