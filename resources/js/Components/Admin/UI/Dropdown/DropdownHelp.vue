  ...
  <div class="relative inline-flex">
    ...
    >
      <div v-show="dropdownOpen"
           class="origin-top-right z-10 absolute top-full min-w-44 bg-white
                  border border-slate-200 py-1.5 rounded shadow-lg overflow-hidden mt-1"
        ...
        >
          <li>
            <button class="font-medium text-sm text-indigo-500
