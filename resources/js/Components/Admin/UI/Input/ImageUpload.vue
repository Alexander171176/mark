...
<template>
    <div
        class="w-full flex flex-col items-center space-y-4 p-4
               bg-gray-200 dark:bg-gray-400 rounded-lg shadow-md"
    >
        <div class="relative w-full h-32 flex items-center justify-center
            ...
            <div class="text-center">
                <svg class="w-8 h-8 text-gray-400 dark:text-yellow-300 mx-auto fill-current"
                     viewBox="0 0 16 16">
                    <path
