...
<template>
    <div class="pt-2 pb-24 space-y-1">
        ...
        <ResponsiveNavLink
            ...
            :active="route().current('admin.marketProductBundles.*')">
            {{ t('marketProductBundles') }}
        </ResponsiveNavLink>
        <ResponsiveNavLink
            :href="route('admin.marketProductVariants.index')"
            :active="route().current('admin.marketProductVariants.*')">
        ...
        <ResponsiveNavLink
            :href="route('admin.marketAttributes.index')"
            :active="route().current('admin.marketAttributes.*')">
            {{ t('marketAttributes') }}
        </ResponsiveNavLink>
        <ResponsiveNavLink
            :href="route('admin.marketAttributeValues.index')"
            :active="route().current('admin.marketAttributeValues.*')">
        ...
        <ResponsiveNavLink
            ...
            :active="route().current('admin.schoolInstructorProfiles.*')">
            {{ t('instructors') }}
        </ResponsiveNavLink>
        <ResponsiveNavLink
            :href="route('admin.schoolHashtags.index')"
            :active="route().current('admin.schoolHashtags.*')">
            {{ t('hashtags') }}
        </ResponsiveNavLink>
        <ResponsiveNavLink
            :href="route('admin.schoolTracks.index')"
            :active="route().current('admin.schoolTracks.*')">
        ...
        <ResponsiveNavLink
            ...
            :active="route().current('admin.schoolCourses.*')">
            {{ t('courses') }}
        </ResponsiveNavLink>
        <ResponsiveNavLink
            :href="route('admin.schoolModules.index')"
            :active="route().current('admin.schoolModules.*')">
            {{ t('modules') }}
        </ResponsiveNavLink>
        <ResponsiveNavLink
            :href="route('admin.schoolLessons.index')"
            :active="route().current('admin.schoolLessons.*')">
            {{ t('lessons') }}
        </ResponsiveNavLink>
        <ResponsiveNavLink
            :href="route('admin.schoolAssignments.index')"
            :active="route().current('admin.schoolAssignments.*')">
            {{ t('assignments') }}
        </ResponsiveNavLink>
        <ResponsiveNavLink
            :href="route('admin.schoolCourseSchedules.index')"
            :active="route().current('admin.schoolCourseSchedules.*')">
            {{ t('courseSchedules') }}
        </ResponsiveNavLink>
        <ResponsiveNavLink
            :href="route('admin.schoolCohortEnrollments.index')"
            :active="route().current('admin.schoolCohortEnrollments.*')">
            {{ t('cohortEnrollments') }}
        </ResponsiveNavLink>
        <ResponsiveNavLink
            :href="route('admin.schoolEnrollments.index')"
            :active="route().current('admin.schoolEnrollments.*')">
            {{ t('enrollments') }}
        </ResponsiveNavLink>
        <ResponsiveNavLink
            :href="route('admin.schoolQuizzes.index')"
            :active="route().current('admin.schoolQuizzes.*')">
            {{ t('quizzes') }}
        </ResponsiveNavLink>
        <ResponsiveNavLink
            :href="route('admin.schoolQuizQuestions.index')"
            :active="route().current('admin.schoolQuizQuestions.*')">
            {{ t('quizQuestions') }}
        </ResponsiveNavLink>
        <ResponsiveNavLink
            :href="route('admin.schoolQuizAnswers.index')"
            :active="route().current('admin.schoolQuizAnswers.*')">
            {{ t('quizAnswers') }}
        </ResponsiveNavLink>
        <ResponsiveNavLink
            :href="route('admin.schoolQuizAttempts.index')"
            :active="route().current('admin.schoolQuizAttempts.*')">
            {{ t('quizAttempts') }}
        </ResponsiveNavLink>
        <ResponsiveNavLink
        ...
        <ResponsiveNavLink
            ...
            :active="route().current('admin.blogArticles.*')">
            {{ t('articles') }}
        </ResponsiveNavLink>
        <ResponsiveNavLink
            :href="route('admin.blogTags.index')"
            :active="route().current('admin.blogTags.*')">
            {{ t('tags') }}
        </ResponsiveNavLink>
        <ResponsiveNavLink
        ...
        <ResponsiveNavLink
            ...
            :active="route().current('admin.parameters.*')">
            {{ t('parameters') }}
        </ResponsiveNavLink>
        <ResponsiveNavLink
