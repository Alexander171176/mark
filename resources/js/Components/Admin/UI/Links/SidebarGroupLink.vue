<script setup>
import SidebarLink from '@/Components/Admin/UI/Links/SidebarLink.vue';
...
<template>
    ...
    <SidebarLink :href="route('admin.cmsPages.index')"
                 :active="route().current('cmsPages.*')"
                 :expanded="props.expanded">
        <template #default>
            <svg class="shrink-0 h-6 w-6" viewBox="0 0 24 24">
                <path class="fill-current text-blue-600"
    ...
    <SidebarLink :href="route('admin.marketShops.index')"
                 :active="route().current('marketShops.*')"
                 :expanded="props.expanded">
        <template #default>
            <svg class="shrink-0 h-6 w-6" viewBox="0 0 24 24">
                <path class="fill-current text-blue-600"
    ...
    <SidebarLink :href="route('admin.marketCategories.index')"
                 :active="route().current('marketCategories.*')"
                 :expanded="props.expanded">
        <template #default>
            <svg class="shrink-0 h-6 w-6" viewBox="0 0 24 24">
                <path class="fill-current text-blue-600"
    ...
    <SidebarLink :href="route('admin.marketProducts.index')"
                 :active="route().current('marketProducts.*')"
                 :expanded="props.expanded">
        <template #default>
            <svg class="shrink-0 h-6 w-6" viewBox="0 0 24 24">
                <path class="fill-current text-blue-600"
    ...
    <SidebarLink :href="route('admin.marketProductBundles.index')"
                 :active="route().current('marketProductBundles.*')"
                 :expanded="props.expanded">
        <template #default>
            <svg class="shrink-0 h-6 w-6" viewBox="0 0 24 24">
                <path class="fill-current text-blue-600"
    ...
    <SidebarLink :href="route('admin.marketProductVariants.index')"
                 :active="route().current('marketProductVariants.*')"
                 :expanded="props.expanded">
        <template #default>
            <svg class="shrink-0 h-6 w-6" viewBox="0 0 24 24">
                <path class="fill-current text-blue-600"
    ...
    <SidebarLink :href="route('admin.marketBrands.index')"
                 :active="route().current('marketBrands.*')"
                 :expanded="props.expanded">
        <template #default>
            <svg class="shrink-0 h-6 w-6" viewBox="0 0 24 24">
                <path class="fill-current text-blue-600"
    ...
    <SidebarLink :href="route('admin.marketTags.index')"
                 :active="route().current('marketTags.*')"
                 :expanded="props.expanded">
        <template #default>
            <svg class="shrink-0 h-6 w-6" viewBox="0 0 24 24">
                <path class="fill-current text-blue-600"
    ...
    <SidebarLink :href="route('admin.marketAttributeGroups.index')"
                 :active="route().current('marketAttributeGroups.*')"
                 :expanded="props.expanded">
        <template #default>
            <svg class="shrink-0 h-6 w-6" viewBox="0 0 24 24">
                <path class="fill-current text-blue-600"
    ...
    <SidebarLink :href="route('admin.marketAttributes.index')"
                 :active="route().current('marketAttributes.*')"
                 :expanded="props.expanded">
        <template #default>
            <svg class="shrink-0 h-6 w-6" viewBox="0 0 24 24">
                <path class="fill-current text-blue-600"
    ...
    <SidebarLink :href="route('admin.marketAttributeValues.index')"
                 :active="route().current('marketAttributeValues.*')"
                 :expanded="props.expanded">
        <template #default>
            <svg class="shrink-0 h-6 w-6" viewBox="0 0 24 24">
                <path class="fill-current text-blue-600"
    ...
    <SidebarLink :href="route('admin.reviews.index')"
    ...
    <SidebarLink :href="route('admin.analyticsVisitorLogs.index')"
                 :active="route().current('analyticsVisitorLogs.*')"
                 :expanded="props.expanded">
        <template #default>
            <svg class="shrink-0 h-6 w-6" viewBox="0 0 24 24">
                <path class="fill-current text-blue-400"
    ...
    <SidebarLink :href="route('admin.locations.index')"
    ...
    <SidebarLink :href="route('admin.localization.index')"
                 :active="route().current('localization.index')"
                 :expanded="props.expanded">
        <template #default>
            <svg class="shrink-0 h-6 w-6" viewBox="0 0 24 24">
                <path class="fill-current text-blue-400" d="M13 15l11-7L11.504.136a1 1 0 00-1.019.007L0 7l13 8z"></path>
