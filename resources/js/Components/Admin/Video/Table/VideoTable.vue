        ...
        <div class="overflow-x-auto">
            <table v-if="videos.length > 0"
                ...
                <tr>
                    ...
                    <th class="px-1 py-1 first:pl-11 last:pr-11 whitespace-nowrap w-px">
                    ...
                    <th class="px-1 py-1 first:pl-11 last:pr-11 whitespace-nowrap">
                    ...
                    <th class="px-1 py-1 first:pl-11 last:pr-11 whitespace-nowrap">
                        <div class="font-medium text-center">{{ t('type') }}</div>
                    </th>
                    <th class="px-1 py-1 first:pl-11 last:pr-11 whitespace-nowrap">
                ...
                >
                    <template #item="{ element: video }">
                        <tr class="text-sm font-semibold border-b-2
                            ...
                            <td class="px-1 py-1 first:pl-11 last:pr-11 whitespace-nowrap w-px">
                                <div class="text-center text-blue-600 dark:text-blue-200">
                                    {{ video.id }}
                                </div>
                            </td>
                            <td class="px-1 py-1 first:pl-11 last:pr-11">
                          ...
                          : 'bg-gray-100 dark:bg-gray-900 text-gray-900 dark:text-gray-100'"
                            ...
                            <td class="px-1 py-1 first:pl-11 last:pr-11 whitespace-nowrap">
                                <div class="flex flex-col items-center justify-center">
                                    <span class="text-[11px] text-indigo-600 dark:text-indigo-200">
                                        {{ video.source_type }}
                                    </span>
                                    <span
                                        class="text-[10px] px-2 py-0 rounded-sm border font-semibold"
