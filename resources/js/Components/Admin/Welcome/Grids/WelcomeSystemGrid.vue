...
<template>
    ...
    >
        ...
        <WelcomeCard
            ...
            <template #icon>
                <svg
                    ...
                    class="w-5 h-5 stroke-gray-900 dark:stroke-gray-100"
                >
                    <circle cx="18.5" cy="5.5" r="4.5"></circle>
        ...
        <WelcomeCard
            ...
            <template #icon>
                ...
                >
                    ...
                    <path d="M12 15.5a3.5 3.5 0 110-7 3.5 3.5 0 010 7z"></path>
                </svg>
            </template>
        </WelcomeCard>
        <WelcomeCard
        ...
        <WelcomeCard
            ...
            title="PHP info"
            :description="descriptions.phpinfo">
            <template #icon>
                <svg
                    xmlns="http://www.w3.org/2000/svg"
                    fill="none"
        ...
        <WelcomeCard
            ...
            title="Composer json"
            :description="descriptions.composer">
            <template #icon>
                <svg
                    xmlns="http://www.w3.org/2000/svg"
                    fill="none"
        ...
        <WelcomeCard
            ...
            :title="t('backups')"
            :description="descriptions.backups">
            <template #icon>
                <svg
                    xmlns="http://www.w3.org/2000/svg"
                    fill="none"
        ...
        <WelcomeCard
            ...
            :title="t('fileBackup')"
            :description="descriptions.fileBackup">
            <template #icon>
                <svg
                    xmlns="http://www.w3.org/2000/svg"
                    fill="none"
        ...
        <WelcomeCard
            ...
            :title="t('robot')"
            :description="descriptions.robot">
            <template #icon>
                <svg
                    xmlns="http://www.w3.org/2000/svg"
                    fill="none"
        ...
        <WelcomeCard
            ...
            :description="descriptions.sitemapTitle">
            <template #icon>
                <svg
                    xmlns="http://www.w3.org/2000/svg"
                    fill="none"
        ...
        <WelcomeCard
            ...
            <template #icon>
                <svg
                    ...
                    class="w-5 h-5 stroke-gray-900 dark:stroke-gray-100"
                >
                    <path d="M16 13v4H8v-4H0l3-9h18l3 9h-8Z"></path>
                    <path
