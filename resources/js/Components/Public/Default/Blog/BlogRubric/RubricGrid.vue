    ...
    >
        ...
        >
            ...
            <article
                ...
                :itemid="getShowRoute(rubric)"
                class="contents"
            >
                <meta
                    itemprop="name"
                    :content="getTitle(rubric)"
                >

                <meta
                    v-if="getShort(rubric)"
                    itemprop="description"
                    :content="getShort(rubric)"
                >

                <meta
                    itemprop="url"
                    :content="getShowRoute(rubric)"
                >
