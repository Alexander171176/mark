        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-1 xl:grid-cols-2 gap-3">
            <div v-for="item in videos" :key="item.id"
                 class="relative flex flex-col overflow-hidden
                        bg-slate-100 dark:bg-[hsl(240_33%_12%)] rounded-sm
                        ...
                        <div class="relative w-full h-full">
                            ...
                            <div class="absolute inset-0 flex items-center justify-center z-20">
                                <button @click="playVideo(item.id)"
                                        class="bg-white/30 hover:bg-white/40 backdrop-blur-md
                                               rounded-full p-2 border-8 border-white/30">
                ...
                <div class="text-center text-sm font-semibold
                            text-slate-800 dark:text-slate-100 px-2 py-3">
