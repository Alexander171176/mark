    ...
    >
        ...
        >
            ...
            >
                ...
                <!-- Изображения -->
                <Link :href="categoryLink(category)" class="block overflow-hidden" itemprop="url">
                ...
                <div class="flex flex-1 flex-col p-4">
                    ...
                    <div class="flex items-center justify-center gap-2 text-center">
                        ...
                        >
                            ...
                            <span class="text-base font-semibold text-slate-900/85 group-hover:opacity-75 dark:text-slate-100/85 dark:group-hover:opacity-75">
                    ...
                    <div
                        ...
                        class="mt-2 text-center text-xs font-semibold text-slate-500 dark:text-slate-400"
                    >
                    ...
                    <!-- Уровень категории -->
                    <div v-if="category.level" class="mt-3 flex items-center justify-center">
                        <div class="rounded-sm border border-slate-400 px-2 py-1 text-xs font-semibold text-slate-500 dark:text-slate-400">
                            {{ t('level') }}:
                            {{ category.level }}
                        </div>
                    </div>
