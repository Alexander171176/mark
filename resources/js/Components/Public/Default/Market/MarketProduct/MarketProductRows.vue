...
<template>
    <div class="space-y-4">
        <div
            ...
            :key="product.id"
            class="group flex flex-col gap-3 rounded-md border border-gray-200 bg-white p-3 shadow-sm transition hover:shadow-md dark:border-gray-700 dark:bg-gray-900 sm:flex-row"
        >
            <!-- Изображения -->
            ...
            <div class="min-w-0 flex-1 flex flex-col justify-around">
                ...
                <div class="flex flex-wrap items-start justify-between gap-3">
                    <div class="min-w-0 flex-1">
                        ...
                        <div
                            ...
                            class="mt-1 flex flex-wrap items-center gap-2 text-[11px] text-slate-400 dark:text-slate-500"
                        >
                ...
                >
                    ...
                    >
                        ...
                        <span
                            v-if="hasStock(product) && quantity(product) > 0"
                        >
                            ({{ quantity(product) }})
                        </span>
                    </div>
                ...
                <div
                    ...
                    class="mt-3 flex items-center justify-center gap-1 text-xs font-semibold text-slate-600/85 dark:text-slate-300/85"
                >
                    <svg
