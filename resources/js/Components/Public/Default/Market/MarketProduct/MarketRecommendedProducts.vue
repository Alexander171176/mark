 ...
 *
 * Flex используется специально,
 * чтобы неполный ряд центрировался.
 */
        ...
        >
            ...
            <div class="relative">
                ...
                >
                    <span
                        v-if="product.is_new"
                        class="rounded-sm bg-teal-500 px-1 py-0.5
                    ...
                    <span
                        v-if="product.is_hit"
                        class="rounded-sm bg-amber-500 px-1 py-0.5
                               text-[9px] font-bold uppercase tracking-wide
                    ...
                    <span
                        ...
                        class="rounded-sm bg-red-500 px-1 py-0.5
                               text-[9px] font-bold uppercase tracking-wide
                               text-white shadow-sm"
                    >
                        SALE
            ...
            <div class="flex flex-1 flex-col px-1 pb-1.5 pt-6">
                <!-- Бренд -->
                <div
                ...
                <!-- Наличие -->
                <div
                    class="flex items-center justify-center gap-1 px-2 py-0
