...
<template>
    <div class="space-y-4">
        <article
            ...
            :key="module.id"
            class="group flex flex-col sm:flex-row gap-3 rounded-md border border-gray-200 bg-white shadow-sm p-3 transition hover:shadow-md dark:border-gray-700 dark:bg-gray-900"
            itemscope
            ...
            <div class="min-w-0 flex-1 flex flex-col justify-around">
                <div class="min-w-0 flex-1 flex flex-col justify-around">
                    <div class="flex items-start justify-between gap-3">
                        <Link :href="moduleLink(module)" class="min-w-0 inline-flex items-center gap-2">
                            <span
