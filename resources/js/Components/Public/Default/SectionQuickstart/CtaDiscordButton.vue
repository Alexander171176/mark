...
const props = defineProps({
    href: { type: String, default: 'https://go.cssninja.io/discord' },
    label: { type: String, default: 'Discord Access' },
})
</script>

<template>
    <a :href="href" class="button is-primary is-raised is-long-2">
        <svg xmlns="http://www.w3.org/2000/svg" aria-hidden="true" role="img"
             width="1.25em" height="1em" viewBox="0 0 640 512" class="iconify mr-1">
