...
<template>
    ...
    >
        ...
        >
            ...
            <span
                class="font-semibold text-slate-600/85
                       dark:text-slate-400/85"
            >
                {{ t('views') }}:
            </span>
        ...
        <!--
            ...
            Сам InteractionCounter для likes добавляем отдельно ниже,
            потому что LikeButtonEntity отвечает за UI и действие пользователя,
            а EntityStats — за семантическое описание статистики.
        -->
        <LikeButtonEntity
        ...
        <!-- Неинтерактивное отображение лайков -->
        <div
        ...
        <!--
            Schema.org:
            количество LikeAction для текущей сущности.
            Скрыто визуально, поскольку число уже выводится
            через LikeButtonEntity либо блок выше.
        -->
        <div
            v-if="likesCount > 0"
            class="hidden"
