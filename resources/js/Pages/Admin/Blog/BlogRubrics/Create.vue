...
// Пропсы страницы (приходят из контроллера)
const props = defineProps({
    targetLocale: { type: String, default: 'ru' }, // язык по умолчанию
...
/**
 * Текущий активный перевод (реактивно)
 */
...
/**
 * Получение ошибки для текущей локали
 */
const getError = (key) => {
            ...
            >
                ...
                <form @submit.prevent="submitForm" enctype="multipart/form-data" class="p-3 w-full">
                    ...
                    <div class="mt-4">
                        ...
                        <div class="text-xs text-slate-600 dark:text-slate-300 mt-2" v-if="newImages.length">
