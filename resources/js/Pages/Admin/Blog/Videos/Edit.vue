...
const form = useForm({
    ...
    pseudonym: props.video.pseudonym ?? '',
            ...
            <div class="p-4 bg-slate-50 dark:bg-slate-700
                ...
                <form @submit.prevent="submitForm" enctype="multipart/form-data" class="p-3 w-full">
                    ...
                    <div class="mb-3 flex flex-col lg:flex-row lg:justify-between lg:space-x-4">
                        ...
                        <div class="flex flex-col lg:flex-row items-center mb-2 lg:mb-0 flex-1">
                            <LabelInput for="source_type" :value="t('sourceType')"
                                        class="mb-1 lg:mb-0 lg:mr-2"/>

                            <select id="source_type" v-model="form.source_type"
                                    class="form-select px-2 py-0.5 min-w-[12rem]
                                           font-semibold text-sm
                                           rounded-sm shadow-sm
                                           dark:bg-cyan-800 dark:text-slate-100
                                           border-slate-500 focus:border-indigo-500
                        ...
                        <div class="flex flex-col lg:flex-row items-center mb-2
                                    lg:mb-0 flex-1 justify-between">
                            <LabelInput for="duration" :value="t('duration')"
                                        class="mb-1 lg:mb-0 lg:mr-2"/>
                            <InputNumber id="duration" type="number"
                                         v-model="form.duration" autocomplete="duration"
