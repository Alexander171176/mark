 ...
 *
 * CmsPageSharedResource передаёт только
...
const truncateText = (
    ...
    const truncated = lastSpaceIndex === -1
        ...
        : string.substring(0, lastSpaceIndex)
            ...
            >
                ...
                <form @submit.prevent="submitForm" class="p-3 w-full">
                    ...
                    <div class="mb-3 flex justify-between flex-col
                                xl:flex-row items-center gap-4">
