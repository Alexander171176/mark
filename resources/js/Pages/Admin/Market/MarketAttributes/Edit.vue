 ...
 *
 * Редактирование характеристики MarketAttribute
 */
...
const makeTranslations = () => {
    const result = {}
    const translations = attributeData.value?.translations || []
...
/** Локаль по умолчанию */
const defaultLocale = props.currentLocale || attributeData.value?.translation?.locale || 'ru'
