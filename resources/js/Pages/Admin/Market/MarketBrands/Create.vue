...
/**
 * Гарантирует наличие перевода для локали.
 *
 * Изменение состояния выполняется вне computed.
 */
...
/** Подготовка перевода при переключении вкладки */
watch(
    activeLocale,
    localeCode => {
