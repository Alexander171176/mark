 ...
 *
 * Редактирование Комании (MarketCompany)
 */
...
const form = useForm({
    ...
    social_links: {
        instagram: companyData.value.social_links?.instagram || '',
        whatsapp: companyData.value.social_links?.whatsapp || '',
        telegram: companyData.value.social_links?.telegram || '',
        facebook: companyData.value.social_links?.facebook || '',
        youtube: companyData.value.social_links?.youtube || '',
    },
                ...
                <form @submit.prevent="submitForm" class="p-3 w-full">
                    ...
                    >
                        ...
                        <div class="mb-3 flex flex-col items-start">
                            ...
                            <InputText
                                id="meta_title"
                                type="text"
                                v-model="currentTranslation.meta_title" maxlength="255" />
                        ...
                        <div class="mb-3 flex flex-col items-start">
                            ...
                            <InputText
                                id="meta_keywords"
                                type="text"
                                v-model="currentTranslation.meta_keywords" maxlength="255" />
                    ...
                    <div class="grid grid-cols-1 lg:grid-cols-3 gap-4 mb-4">
                        <div class="flex flex-col items-start">
                            ...
                            <InputText
                                ...
                                type="text"
                                v-model="form.url"
                                required @focus="handleUrlInputFocus" />
                    ...
                    <div class="grid grid-cols-1 lg:grid-cols-3 gap-4 mb-4">
                        ...
                        <EditImageFileInput
                            ...
                            :initial-preview="signaturePreview"
                    ...
                    <div class="grid grid-cols-1 lg:grid-cols-3 gap-4 mb-4">
                        ...
                        <div class="flex flex-col items-start">
                            ...
                            <InputText
                                id="show_from_at"
                                type="datetime-local" v-model="form.show_from_at" />
                        ...
                        <div class="flex flex-col items-start">
                            ...
                            <InputText
                                id="show_to_at"
                                type="datetime-local" v-model="form.show_to_at" />
