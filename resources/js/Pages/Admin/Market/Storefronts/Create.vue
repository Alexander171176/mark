 ...
 * Создание витрины (MarketStorefront)
 */
...
const submitForm = () => {
    ...
    form.post(route('admin.marketStorefronts.store'), {
        preserveScroll: true,
        onSuccess: () => {
            toast.success('Витрина успешно создана!')
        },
        onError: (errors) => {
            console.error('❌ Ошибка при создании витрины:', errors)
...
<template>
    <AdminLayout :title="t('addMarketStorefront')">
        <template #header>
            <TitlePage>{{ t('addMarketStorefront') }}</TitlePage>
        </template>
        ...
        <div class="px-4 sm:px-6 lg:px-8 py-8 w-full max-w-12xl mx-auto">
            ...
            >
                ...
                <form @submit.prevent="submitForm" class="p-3 w-full">
                    ...
                    <div class="mb-3 grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div class="flex flex-col items-start w-full">
                            <LabelInput for="default_locale" :value="t('localization')" />
                            <select
                                id="default_locale"
                        ...
                        <div class="flex flex-col items-start w-full">
                            <LabelInput for="default_currency_id" :value="t('mainCurrency')" />
                            <select
                    ...
                    <div class="mb-3 flex flex-col items-start">
                        <div class="flex justify-between w-full">
                            <LabelInput for="note" :value="t('comment')" />
                        </div>
                        <MetaDescTextarea
                            id="note"
                            v-model="form.note"
