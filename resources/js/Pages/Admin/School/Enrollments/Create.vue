 ...
 * Создание зачисления (Enrollment)
 */
 ...
 * Поля совпадают с $fillable модели Enrollment.
 */
const form = useForm({
    user_id: null,
    course_id: null,
    ...
    progress_percent: 0,
    notes: ''
    // meta можно добавить позже как JSON, пока опустим
})
 ...
 * (должно совпадать с бэком / валидацией)
 */
const statusOptions = [
    'active',
    'completed',
...
const submitForm = () => {
    form.post(route('admin.enrollments.store'), {
        preserveScroll: true,
        onSuccess: () => {
            toast.success('Зачисление успешно создано')
        },
        onError: (errors) => {
            console.error('❌ Ошибка при создании зачисления:', errors)
        ...
        <div class="px-4 sm:px-6 lg:px-8 py-8 w-full max-w-12xl mx-auto">
            ...
            >
                ...
                <div class="sm:flex sm:justify-between sm:items-center mb-2">
                    <DefaultButton :href="route('admin.enrollments.index')">
                        <template #icon>
                            <svg
