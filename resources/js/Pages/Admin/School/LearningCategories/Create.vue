 ...
 * Создание категории курсов (паттерн)
 */
import { ref } from 'vue'
...
/** Форма создания категории курсов */
const form = useForm({
    parent_id: null,
    sort: '0',
    name: '', // Название
...
/** Дерево категорий */
const learningCategory = usePage();

/** Опции дочерних субкатегорий */
const parentOptions = buildParentOptions(learningCategory.props.potentialParents);
...
/**
 * Отправляет данные формы для создания категории.
 */
const submit = () => {
    ...
    form.post(route('admin.learningCategories.store'), {
        errorBag: 'createLearningCategory', // Имя для ошибок валидации
        ...
        onSuccess: () => {
            ...
            toast.success('Категория обучения успешно создана!');
...
<template>
    <AdminLayout :title="t('addLearningCategory')">
        <template #header>
            <TitlePage>
        ...
        <div class="px-2 py-2 w-full max-w-12xl mx-auto">
            <div class="p-4 bg-slate-50 dark:bg-slate-700
                ...
                <div class="sm:flex sm:justify-between sm:items-center mb-2">
                    ...
                    { locale: learningCategory.props.targetLocale })">
                        <template #icon>
