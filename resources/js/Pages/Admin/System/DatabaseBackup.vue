...
/*
|--------------------------------------------------------------------------
| Обновление статуса восстановления
|--------------------------------------------------------------------------
*/
...
/*
|--------------------------------------------------------------------------
| Проверять статус восстановления
|--------------------------------------------------------------------------
*/
...
const pollRestoreStatus = async (
    ...
    try {
        ...
        const message =
            'Получен неизвестный статус задачи восстановления'
