...
const props = defineProps({
    ...
    adminSystemSettingsPerPage: Number,
    adminSystemSettingsDefaultSort: String,
});
 ...
 */
const itemsPerPage = ref(props.adminSystemSettingsPerPage); // Используем значение из props
 ...
 */
const sortParam = ref(props.adminSystemSettingsDefaultSort); // Используем значение из props
...
const bulkToggleActivity = (newActivity) => {
    ...
    router.put(
        ...
        { ids: selectedSettings.value, activity: newActivity },
        {
            preserveScroll: true,
            preserveState: true,
            onSuccess: () => {
                ...
                paginatedSettings.value.forEach(l => {
