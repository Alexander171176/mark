        ...
        <div class="px-4 sm:px-6 lg:px-8 py-8 w-full max-w-12xl mx-auto">
            <div class="p-4 bg-slate-50 dark:bg-slate-700
                ...
                <div class="py-4 flex flex-wrap justify-around relative bg-white dark:bg-slate-700">
                    ...
                    <div
                        v-if="props.role.permissions?.length"
                        class="relative w-96
                    ...
                    >
                        ...
                        <div class="overflow-x-auto">
                            <table class="table-auto w-full">
                                ...
                                <tr
                                    v-for="rolePermission in (props.role.permissions || [])"
                                ...
                                >
                                    ...
                                    <td class="px-2 first:pl-5 last:pr-5 py-1 whitespace-nowrap">
                                        <div class="flex justify-center">
                                            <DeleteButton
                                                :href="route('admin.roles.permissions.destroy', [props.role.id, rolePermission.id])"
                                            />
                                        </div>
                                    </td>
                                </tr>
