        ...
        <transition name="top-panel">
            <div v-if="isPanelOpen"
                ...
                <Link
                    ...
                    :title="t('backups')"
                    :class="{ 'active-link': route().current('admin.backup.index'),
                    'base-link': true }"
                >
                    <svg class="shrink-0 h-4 w-4" viewBox="0 0 24 24">
                        <path class="fill-current text-cyan-400"
                ...
                <Link
                    ...
                    :title="t('reports')"
                    :class="{ 'active-link': route().current('admin.reports.index'),
                    'base-link': true }"
                >
                    <svg class="shrink-0 h-4 w-4" viewBox="0 0 24 24">
                        <path class="fill-current text-cyan-600"
                ...
                >
                    <svg class="shrink-0 h-4 w-4" viewBox="0 0 24 24">
                        <path class="fill-current text-cyan-400"
                              d="M17,11.94q-.16.626-.922,3.091h1.86q-.719-2.309-.808-2.612C17.072,12.218,17.028,12.058,17,11.94Z"></path>
                        <path class="fill-current text-cyan-400"
                              d="M22,8H12a2,2,0,0,0-2,2v9a2,2,0,0,0,2,2h6l4,3V21a2,2,0,0,0,2-2V10A2,2,0,0,0,22,8ZM18.819,18,18.3,16.3H15.7L15.181,18H13.55l2.52-7.168h1.85L20.45,18Z"></path>
                        <path class="fill-current text-cyan-400"
                        ...
                        <path class="fill-current text-cyan-400"
                              d="M7.016,6.642a4.51,4.51,0,0,0,1-1.935H5.9A4.562,4.562,0,0,0,7.016,6.642Z"></path>
                    </svg>
                </Link>
