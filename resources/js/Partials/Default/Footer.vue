...
<template>
    <footer class="landing-footer bg-[hsl(240_4%_14%)]">
        <div class="container">
            <div class="footer-flex">
                <div class="listkit">
                    <div class="logo">
                        <img class="is-image is-image-block is-image is-image-light"
                             src="./../../../images/vulk/logo.svg" alt=""
                             width="45" height="45" loading="lazy">
                        <img class="is-image is-image-block is-image is-image-dark"
                             src="./../../../images/vulk/logo.svg"
                             alt="" width="45" height="45" loading="lazy">
                    </div>
                    <img class="vulk-logo"
                         src="data:image/svg+xml,%3csvg%20version=&#39;1.1&#39;%20id=&#39;Layer_1&#39;%20xmlns=&#39;http://www.w3.org/2000/svg&#39;%20x=&#39;0&#39;%20y=&#39;0&#39;%20viewBox=&#39;0%200%20256%2077&#39;%20style=&#39;enable-background:new%200%200%20256%2077&#39;%20xml:space=&#39;preserve&#39;%3e%3cstyle%3e.st0{fill:%23fff}%3c/style%3e%3cpath%20class=&#39;st0&#39;%20d=&#39;M40.2.2h20.4L40.7%2076.9h-.4l.1.1H20.1v-.1h-.2L0%20.2h20.4l9.9%2038%209.9-38zM124.6%2076.6H63.9V.1h20.7l.2%2060.5h18.5V.5h.4V.1h20.7l.2%2076.5zM148.9%2060.2h33.8l6%2016.4H128V.1h20.7l.2%2060.1zM224.4%2039.4%20256%2076.6h-24.4l-19.1-20.7V76.6h-20.6V52.2l-.1-.1.1-.1V.1h20.7l-.1%2021.8L227.6%200h24.8l-.6.7h.4l-27.8%2038.7z&#39;/%3e%3c/svg%3e"
                         alt="Vulk Logo">
                </div>
                <div class="ninja">
                    <div class="made-by">
                        <span role="img" aria-label="Copyright">
                            © 2022-2023 | Designed and coded with
                        </span>
                        <svg xmlns="http://www.w3.org/2000/svg"
                             aria-hidden="true" role="img"
                             width="1em" height="1em"
                             viewBox="0 0 24 24" data-icon="feather:heart"
                             class="iconify love iconify--feather">
                            <path fill="none"
                                  stroke="currentColor"
                                  stroke-linecap="round"
                                  stroke-linejoin="round"
                                  stroke-width="2"
                                  d="M20.84 4.61a5.5 5.5 0 0 0-7.78 0L12 5.67l-1.06-1.06a5.5 5.5 0 0 0-7.78 7.78l1.06 1.06L12 21.23l7.78-7.78l1.06-1.06a5.5 5.5 0 0 0 0-7.78"></path>
                        </svg>
                        by
                    </div>
                    <div class="has-text-centered flex justify-center">
                        ...
                        c2.7,2.6,4,6.4,4,11.3c0,5.5-1.5,9.9-4.6,13.1c-3.1,3.4-7.4,4.9-12.7,4.9C1153.5,96.3,1149.5,94.9,1146.9,92.1z"></path>
                        </g></g>
                        </svg>
                        </a>
                    </div>
