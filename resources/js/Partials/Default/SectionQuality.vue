<script setup>
import FeatureItem from '@/Components/Public/Default/Quality/FeatureItem.vue'
</script>

<template>
    <div class="dark:bg-[hsl(240_33%_9%)]">
        <div class="section-content">
            <div class="container">
                <div class="has-text-centered pt-12">
                    <h3 class="subtitle is-5 is-bold">
                        <span class="text-gradient">Carefully Handcrafted</span>
                    </h3>
                    <h2 class="title is-3 is-bold dark:text-white">
                        <span>Vulk is a Top-Tier product</span>
                    </h2>
                </div>
                <div class="demo-features pt-12">
                    <div class="columns b-columns-half-tablet-p">
                        <div class="column is-5">
                            <!-- Feature -->
                            <!-- 1 -->
                            <FeatureItem top-title="Modern Framework" title="Vue 3"
                                         reveal-from="bottom" :delay="0">
                                <template #icon>
                                    <svg xmlns="http://www.w3.org/2000/svg" aria-hidden="true" role="img" width="1em" height="1em" viewBox="0 0 24 24" data-icon="uit:vuejs-alt" class="iconify iconify--uit">
                            ...
                            <!-- 2 -->
                            <FeatureItem top-title="Easy Partials" title="Vite JS"
                                         reveal-from="bottom" :delay="80">
                                <template #icon>
                                    <svg xmlns="http://www.w3.org/2000/svg" aria-hidden="true" role="img" width="1em" height="1em" viewBox="0 0 510 512" data-icon="file-icons:vite" class="iconify iconify--file-icons">
                            ...
                            <!-- 3 -->
                            <FeatureItem top-title="Bulma Framework" title="Modular CSS"
                                         reveal-from="bottom" :delay="160">
                                <template #icon>
                                    <svg xmlns="http://www.w3.org/2000/svg" aria-hidden="true" role="img" width="1em" height="1em" viewBox="0 0 24 24" data-icon="iconoir:css3" class="iconify iconify--iconoir">
                                        <g fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5">
                                            <path d="m4 3l1.778 17.09L12 22l6.222-1.91L20 3z"></path>
                                            <path d="M7 7h9.5l-1 10l-3.5 1l-3.5-1l-.25-2.5m7.75-3H7.5"></path>
                                        </g>
                                    </svg>
                                </template>
                                <p>
                            ...
                            <!-- 4 -->
                            <FeatureItem top-title="Custom SSR" title="SSG/SSR Ready"
                                         reveal-from="bottom" :delay="240">
                                <template #icon>
                                    <svg xmlns="http://www.w3.org/2000/svg" aria-hidden="true" role="img" width="1em" height="1em" viewBox="0 0 256 256" data-icon="ph:browsers-thin" class="iconify iconify--ph">
                                        <path fill="currentColor" d="M216 44H72a12 12 0 0 0-12 12v20H40a12 12 0 0 0-12 12v112a12 12 0 0 0 12 12h144a12 12 0 0 0 12-12v-20h20a12 12 0 0 0 12-12V56a12 12 0 0 0-12-12M40 84h144a4 4 0 0 1 4 4v20H36V88a4 4 0 0 1 4-4m148 116a4 4 0 0 1-4 4H40a4 4 0 0 1-4-4v-84h152Zm32-32a4 4 0 0 1-4 4h-20V88a12 12 0 0 0-12-12H68V56a4 4 0 0 1 4-4h144a4 4 0 0 1 4 4Z"></path>
                                    </svg>
                                </template>
                                <p>
                            ...
                            <!-- 5 -->
                            <FeatureItem top-title="Solid structure" title="600+ Components"
                                         reveal-from="bottom" :delay="320">
                                <template #icon>
                                    <svg xmlns="http://www.w3.org/2000/svg" aria-hidden="true" role="img" width="1em" height="1em" viewBox="0 0 256 256" data-icon="ph:code-simple-light" class="iconify iconify--ph">
                                        <path fill="currentColor" d="M92 68.49L25 128l67 59.52a6 6 0 1 1-8 9l-72-64a6 6 0 0 1 0-9l72-64a6 6 0 0 1 8 9Zm152 55l-72-64a6 6 0 0 0-8 9L231 128l-67 59.52a6 6 0 1 0 8 9l72-64a6 6 0 0 0 0-9Z"></path>
                                    </svg>
                                </template>
                                <p>
                            ...
                            <!-- 6 -->
                            <FeatureItem top-title="Quickstart" title="100+ Prebuilt pages"
                                         reveal-from="bottom" :delay="400">
                                <template #icon>
                                    <svg xmlns="http://www.w3.org/2000/svg" aria-hidden="true" role="img" width="1em" height="1em" viewBox="0 0 256 256" data-icon="ph:layout-light" class="iconify iconify--ph">
                                        <path fill="currentColor" d="M216 42H40a14 14 0 0 0-14 14v144a14 14 0 0 0 14 14h176a14 14 0 0 0 14-14V56a14 14 0 0 0-14-14M40 54h176a2 2 0 0 1 2 2v42H38V56a2 2 0 0 1 2-2m-2 146v-90h60v92H40a2 2 0 0 1-2-2m178 2H110v-92h108v90a2 2 0 0 1-2 2"></path>
                                    </svg>
                                </template>
                                <p>
                            ...
                            <!-- 7 -->
                            <FeatureItem top-title="For Everything" title="Multipurpose"
                                         reveal-from="bottom" :delay="480">
                                <template #icon>
                                    <svg xmlns="http://www.w3.org/2000/svg" aria-hidden="true" role="img" width="1em" height="1em" viewBox="0 0 256 256" data-icon="ph:magic-wand-light" class="iconify iconify--ph">
                                        <path fill="currentColor" d="M246 152a6 6 0 0 1-6 6h-18v18a6 6 0 0 1-12 0v-18h-18a6 6 0 0 1 0-12h18v-18a6 6 0 0 1 12 0v18h18a6 6 0 0 1 6 6M56 70h18v18a6 6 0 0 0 12 0V70h18a6 6 0 0 0 0-12H86V40a6 6 0 0 0-12 0v18H56a6 6 0 0 0 0 12m128 124h-10v-10a6 6 0 0 0-12 0v10h-10a6 6 0 0 0 0 12h10v10a6 6 0 0 0 12 0v-10h10a6 6 0 0 0 0-12m33.9-115.41L78.58 217.9a14 14 0 0 1-19.8 0l-20.69-20.69a14 14 0 0 1 0-19.8L177.41 38.1a14 14 0 0 1 19.8 0l20.69 20.69a14 14 0 0 1 0 19.8M167.51 112L144 88.49L46.58 185.9a2 2 0 0 0 0 2.83l20.69 20.68a2 2 0 0 0 2.82 0Zm41.9-44.73l-20.68-20.68a2 2 0 0 0-2.83 0L152.48 80L176 103.52l33.41-33.42a2 2 0 0 0 0-2.83"></path>
                                    </svg>
                                </template>
                                <p>
                                    Vulk is a multipurpose landing UI kit. It is also mademfor any type of modern website or web application. Featured content will of course continue to grow with future updates.
                                </p>
                            </FeatureItem>

                            <!-- 8 -->
                            <FeatureItem top-title="Mobile First" title="Ultra Responsive"
                                         reveal-from="bottom" :delay="560">
                                <template #icon>
                                    <svg xmlns="http://www.w3.org/2000/svg" aria-hidden="true" role="img" width="1em" height="1em" viewBox="0 0 256 256" data-icon="ph:device-mobile-light" class="iconify iconify--ph">
                                        <path fill="currentColor" d="M176 18H80a22 22 0 0 0-22 22v176a22 22 0 0 0 22 22h96a22 22 0 0 0 22-22V40a22 22 0 0 0-22-22M70 62h116v132H70Zm10-32h96a10 10 0 0 1 10 10v10H70V40a10 10 0 0 1 10-10m96 196H80a10 10 0 0 1-10-10v-10h116v10a10 10 0 0 1-10 10"></path>
                                    </svg>
                                </template>
                                <p>
                            ...
                            <!-- 9 -->
                            <FeatureItem top-title="All Inclusive" title="Cool Vectors"
                                         reveal-from="bottom" :delay="640">
                                <template #icon>
                                    <svg xmlns="http://www.w3.org/2000/svg" aria-hidden="true" role="img" width="1em" height="1em" viewBox="0 0 512 512" data-icon="cil:vector" class="iconify iconify--cil">
                            ...
                            <!-- 10 -->
                            <FeatureItem top-title="Customization" title="Easy Theming"
                                         reveal-from="bottom" :delay="720">
                                <template #icon>
                                    <svg xmlns="http://www.w3.org/2000/svg" aria-hidden="true" role="img" width="1em" height="1em" viewBox="0 0 256 256" data-icon="ph:paint-brush-broad-light" class="iconify iconify--ph">
                                        <path fill="currentColor" d="M216 26H72a38 38 0 0 0-38 38v72a22 22 0 0 0 22 22h48a2 2 0 0 1 2 2.23L98.08 207a7 7 0 0 0-.08 1a30 30 0 0 0 60 0a7 7 0 0 0-.08-1L150 160.23a2 2 0 0 1 2-2.23h48a22 22 0 0 0 22-22V32a6 6 0 0 0-6-6M72 38h106v42a6 6 0 0 0 12 0V38h20v68H46V64a26 26 0 0 1 26-26m128 108h-48a14 14 0 0 0-13.86 16v.15l7.86 46.32a18 18 0 0 1-36 0l7.82-46.34v-.15A14 14 0 0 0 104 146H56a10 10 0 0 1-10-10v-18h164v18a10 10 0 0 1-10 10"></path>
                                    </svg>
                                </template>
                                <p>
                            ...
                            <!-- 11 -->
                            <FeatureItem top-title="Updates &amp; Support" title="Active Support"
                                         reveal-from="bottom" :delay="800">
                                <template #icon>
                                    <svg xmlns="http://www.w3.org/2000/svg" aria-hidden="true" role="img" width="1em" height="1em" viewBox="0 0 256 256" data-icon="ph:lifebuoy-light" class="iconify iconify--ph">
                        ...
                        <div class="column is-7">
                            <img class="is-image is-image-block is-image-light long-screenshot"
                                 src="./../../../images/vulk/vulk-page-1.png"
                                 alt="Long screenshot">
                            <img class="is-image is-image-block is-image-dark long-screenshot"
                                 src="./../../../images/vulk/vulk-page-1-dark.png"
                                 alt="Long screenshot">
                        </div>
                    </div>
                </div>
        ...
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 320">
            <path class="wave-grey" fill-opacity="1"
                  d="M0,224L60,224C120,224,240,224,360,229.3C480,235,600,245,720,234.7C840,224,960,192,1080,197.3C1200,203,1320,245,1380,266.7L1440,288L1440,320L1380,320C1320,320,1200,320,1080,320C960,320,840,320,720,320C600,320,480,320,360,320C240,320,120,320,60,320L0,320Z"></path>
        </svg>
    </div>
</template>
