export const sidebarIcons = {
    ...
    dashboard: `
      <svg class="shrink-0 h-4 w-4" viewBox="0 0 24 24">
        <path class="fill-current text-cyan-600"
        d="M15,18v2H9v-2H1v5c0,0.552,0.448,1,1,1h20c0.552,0,1-0.448,1-1v-5H15z"></path>
        <path class="fill-current text-cyan-500"
    ...
    apiTokens: `
      <svg class="shrink-0 h-4 w-4" viewBox="0 0 24 24">
        <path class="fill-current text-cyan-700"
    ...
    bundles: `
      <svg class="shrink-0 h-4 w-4" viewBox="0 0 24 24">
        ...
        cx="18.5" cy="8.5" r="5.5"></circle>
        <rect class="fill-current text-cyan-400"
        x="5" y="14" width="9" height="9" rx="1"></rect>
        <path class="fill-current text-cyan-400"
        d="M10.932,9.752a.5.5,0,0,0,0-.5l-4.5-8a.52.52,0,0,0-.872,0l-4.5,8A.5.5,0,0,0,1.5,10h9A.5.5,0,0,0,10.932,9.752Z"></path>
      </svg>
    `,
    courses: `
      <svg class="shrink-0 h-4 w-4" viewBox="0 0 448 512">
        <path class="fill-current text-cyan-500"
    ...
    modules: `
      <svg class="shrink-0 h-4 w-4" viewBox="0 0 24 24">
        <rect class="fill-current text-cyan-600"
    ...
    lessons: `
      <svg class="shrink-0 h-4 w-4" viewBox="0 0 24 24">
        <path class="fill-current text-cyan-400" stroke-linecap="round" stroke-linejoin="round"
    ...
    cohortEnrollments: `
      <svg class="shrink-0 h-4 w-4" viewBox="0 0 24 24">
        <path class="fill-current text-cyan-400"
        d="M22,23H2c-.553,0-1-.448-1-1s.447-1,1-1H22c.553,0,1,.448,1,1s-.447,1-1,1Z"></path>
        <path class="fill-current text-cyan-400"
        d="M18.414,8l2-2c.378-.378,.586-.88,.586-1.414s-.208-1.037-.586-1.414l-1.586-1.586c-.779-.78-2.049-.78-2.828,0l-2,2,4.414,4.414Z"></path>
        <path class="fill-current text-cyan-600"
        d="M12.586,5l-7.293,7.293c-.096,.096-.171,.21-.222,.335l-2,5c-.148,.372-.062,.796,.222,1.079,.191,.191,.447,.293,.707,.293,.125,0,.251-.023,.371-.071l5-2c.126-.05,.24-.126,.336-.222l7.293-7.293-4.414-4.414Z"></path>
      </svg>
    `,
    enrollments: `
      <svg class="shrink-0 h-4 w-4" viewBox="0 0 24 24">
        <path class="fill-current text-cyan-500"
        d="M22.641,4.232c-.427-.354-1.056-.296-1.409,.128L11.933,15.519l-.433-.433-1.286,1.543,1.078,1.078c.188,.188,.442,.293,.707,.293,.015,0,.03,0,.045,0,.281-.013,.543-.143,.724-.359L22.769,5.64c.354-.424,.296-1.055-.128-1.408Z"></path>
        <path class="fill-current text-cyan-400"
        d="M6,18c-.265,0-.52-.105-.707-.293L1.293,13.707c-.391-.391-.391-1.023,0-1.414s1.023-.391,1.414,0l3.226,3.226L15.231,4.36c.354-.424,.983-.481,1.409-.128,.424,.354,.481,.984,.128,1.408L6.769,17.64c-.181,.216-.442,.346-.724,.359-.015,0-.03,0-.045,0Z"></path>
      </svg>
    `,
    quizzes: `
      <svg class="shrink-0 h-4 w-4" viewBox="0 0 24 24">
        <path class="fill-current text-cyan-400"
        d="M20,1H4c-1.654,0-3,1.346-3,3V20c0,1.654,1.346,3,3,3H20c1.654,0,3-1.346,3-3V4c0-1.654-1.346-3-3-3ZM12,19.5c-.69,0-1.25-.56-1.25-1.25s.56-1.25,1.25-1.25,1.25,.56,1.25,1.25-.56,1.25-1.25,1.25Zm2.688-7.198c-1.444,1.224-1.688,1.667-1.688,2.198,0,.553-.448,1-1,1s-1-.447-1-1c0-1.434,.807-2.379,2.395-3.724,.447-.38,1.844-1.72,1.025-3.046-.532-.86-2.515-.984-4.162-.256-.505,.22-1.096-.005-1.319-.511-.223-.505,.005-1.096,.51-1.319,2.329-1.028,5.462-.924,6.672,1.035,1.103,1.784,.554,3.938-1.433,5.622Z"></path>
      </svg>
    `,
    quizQuestions: `
      <svg class="shrink-0 h-4 w-4" viewBox="0 0 24 24">
    ...
    quizAnswers: `
      <svg class="shrink-0 h-4 w-4" viewBox="0 0 24 24">
        <path class="fill-current text-cyan-500"
        d="M12,0C5.383,0,0,5.383,0,12s5.383,12,12,12,12-5.383,12-12S18.617,0,12,0Zm1,17c0,.553-.448,1-1,1s-1-.447-1-1v-6c0-.553,.448-1,1-1s1,.447,1,1v6Zm-1-9c-.69,0-1.25-.56-1.25-1.25s.56-1.25,1.25-1.25,1.25,.56,1.25,1.25-.56,1.25-1.25,1.25Z"></path>
      </svg>
    `,
    quizAttempts: `
      <svg class="shrink-0 h-4 w-4" viewBox="0 0 24 24">
        <path class="fill-current text-cyan-400"
        d="M22,15a1,1,0,0,1,0-2h1.949a11.941,11.941,0,0,0-2.794-6.741L19.778,7.636a1,1,0,1,1-1.414-1.414l1.377-1.377A11.941,11.941,0,0,0,13,2.051V4a1,1,0,0,1-2,0V2.051A12.006,12.006,0,0,0,.051,13H2a1,1,0,0,1,0,2H.044a12.025,12.025,0,0,0,2.7,6.637l.3.363H20.956l.3-.363A12.025,12.025,0,0,0,23.956,15Zm-8.586.414a2,2,0,0,1-2.828,0c-.6-.6-4.552-6.468-5-7.135a.5.5,0,0,1,.694-.694c.667.448,6.533,4.4,7.135,5A2,2,0,0,1,13.414,15.414Z"></path>
      </svg>
    `,
    quizAttemptItems: `
      <svg class="shrink-0 h-4 w-4" viewBox="0 0 24 24">
        <path class="fill-current text-cyan-200"
        d="M12,15.75l3.882-1.941-3.435-1.717a1,1,0,0,0-.894,0L8.118,13.809Z"></path>
        <path class="fill-current text-cyan-600"
        d="M13,17.486v5.382l3.447-1.724A1,1,0,0,0,17,20.25V15.486Z"></path>
        <path class="fill-current text-cyan-400"
        d="M11,17.486l-4-2V20.25a1,1,0,0,0,.553.894L11,22.868Z"></path>
        <path class="fill-current text-cyan-200"
        d="M6,5.014,9.881,3.073,6.447,1.356a1,1,0,0,0-.9,0L2.118,3.073Z"></path>
        <path class="fill-current text-cyan-600"
        d="M7,6.75v5.382l3.447-1.724A1,1,0,0,0,11,9.514V4.75Z"></path>
        <path class="fill-current text-cyan-400"
        d="M5,6.75l-4-2V9.514a1,1,0,0,0,.552.894L5,12.132Z"></path>
        <path class="fill-current text-cyan-200"
        d="M18,5.014l3.882-1.941L18.447,1.356a1,1,0,0,0-.894,0L14.118,3.073Z"></path>
        <path class="fill-current text-cyan-600"
        d="M19,6.75v5.382l3.447-1.724A1,1,0,0,0,23,9.514V4.75Z"></path>
        <path class="fill-current text-cyan-400"
        d="M17,6.75l-4-2V9.514a1,1,0,0,0,.553.894L17,12.132Z"></path>
      </svg>
    `,
    orders: `
      <svg class="shrink-0 h-4 w-4" viewBox="0 0 24 24">
        ...
        <polygon class="fill-current text-cyan-200"
    ...
    subscriptionPlans: `
      <svg class="shrink-0 h-4 w-4" viewBox="0 0 24 24">
        ...
        stroke="#67e8f9" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"
    ...
    articles: `
      <svg class="shrink-0 h-4 w-4" viewBox="0 0 24 24">
        <path class="fill-current text-cyan-400"
        d="M21,0H3c-.552,0-1,.448-1,1V23c0,.552,.448,1,1,1H21c.552,0,1-.448,1-1V1c0-.552-.448-1-1-1Zm-3,19.5c0,.276-.224,.5-.5,.5H6.5c-.276,0-.5-.224-.5-.5v-1c0-.276,.224-.5,.5-.5h11c.276,0,.5,.224,.5,.5v1Zm0-5c0,.276-.224,.5-.5,.5H6.5c-.276,0-.5-.224-.5-.5v-1c0-.276,.224-.5,.5-.5h11c.276,0,.5,.224,.5,.5v1Zm0-5c0,.276-.224,.5-.5,.5H6.5c-.276,0-.5-.224-.5-.5V4.5c0-.276,.224-.5,.5-.5h11c.276,0,.5,.224,.5,.5v5Z"></path>
      </svg>
    `,
    tags: `
      <svg class="shrink-0 h-4 w-4" viewBox="0 0 24 24">
    ...
    settings: `
      <svg class="shrink-0 h-4 w-4" viewBox="0 0 24 24">
        ...
        <path class="fill-current text-cyan-400"
        d="M12 15.5a3.5 3.5 0 110-7 3.5 3.5 0 010 7z"></path>
      </svg>
    `,
    parameters: `
      <svg class="shrink-0 h-4 w-4" viewBox="0 0 24 24">
