...
return [
    ...
    // Приватность
    'is_private.required' => 'Поле приватность обязательно для заполнения.',
    'is_private.boolean' => 'Поле приватность должно быть логическим значением.',
    ...
    'locale.max' => 'Код языка не должен превышать 10 символов.',
    ...
    'subtitle.max' => 'Подзаголовок не должен превышать 255 символов.',
    ...
    'pseudonym.string' => 'Псевдоним должен быть строкой.',
    'pseudonym.max' => 'Псевдоним не должен превышать 255 символов.',
    ...
    'show_from_at.date' => 'Некорректный формат начала даты публикования.',
    'show_from_at.date_format' => 'Некорректный формат начала даты публикования (ожидается ГГГГ-ММ-ДД-ЧЧ-ММ).',
    'show_to_at.date' => 'Некорректный формат окончания даты публикования.',
    'show_to_at.date_format' => 'Некорректный формат окончания даты публикования (ожидается ГГГГ-ММ-ДД-ЧЧ-ММ).',
    ...
    // videos
    'videos.array' => 'Видео должны быть массивом.',
    'videos.*.id.required_with' => 'ID видео обязателен.',
    'videos.*.id.integer' => 'ID видео должен быть числом.',
    'videos.*.id.exists' => 'Выбрано несуществующее видео.',

    // moderation
    'moderation_status.integer' => 'Статус модерации должен быть числом.',
    'moderation_status.in' => 'Недопустимый статус модерации.',
    'moderation_note.string' => 'Комментарий модерации должен быть строкой.',
    'moderation_note.max' => 'Комментарий модерации не должен превышать 500 символов.',

    // img
    'img.string' => 'Поле изображения (img) должно быть строкой.',

    // display window
    'show_to_at.after_or_equal' => 'Дата окончания показа должна быть больше или равна дате начала показа.',
    ...
    'parent_id.not_in' => 'Рубрика не может быть дочерней для самой себя.',
    ...
    // в меню
    'in_menu.required' => 'Поле «Показывать в меню» обязательно для заполнения.',
