...
Route::put('/market-product-bundles/{marketProductBundle}/approve',
    [MarketProductBundleController::class, 'approve'])
    ->whereNumber('marketProductBundle')
    ->name('marketProductBundles.approve');
...
Route::put('/market-attributes/{marketAttribute}/approve',
