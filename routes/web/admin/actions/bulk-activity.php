...
Route::put('/market-products/bulk-activity',
    [MarketProductController::class, 'bulkUpdateActivity'])
    ->name('marketProducts.bulkUpdateActivity');

Route::put('/market-product-bundles/bulk-activity',
    [MarketProductBundleController::class, 'bulkUpdateActivity'])
    ->name('marketProductBundles.bulkUpdateActivity');

Route::put('/market-product-variants/bulk-activity',
    [MarketProductVariantController::class, 'bulkUpdateActivity'])
    ->name('marketProductVariants.bulkUpdateActivity');

Route::put('/market-brands/bulk-activity',
    [MarketBrandController::class, 'bulkUpdateActivity'])
    ->name('marketBrands.bulkUpdateActivity');

Route::put('/market-tags/bulk-activity',
    [MarketTagController::class, 'bulkUpdateActivity'])
    ->name('marketTags.bulkUpdateActivity');

Route::put('/market-attribute-groups/bulk-activity',
    [MarketAttributeGroupController::class, 'bulkUpdateActivity'])
    ->name('marketAttributeGroups.bulkUpdateActivity');

Route::put('/market-attributes/bulk-activity',
    [MarketAttributeController::class, 'bulkUpdateActivity'])
    ->name('marketAttributes.bulkUpdateActivity');

Route::put('/market-attribute-values/bulk-activity',
    [MarketAttributeValueController::class, 'bulkUpdateActivity'])
    ->name('marketAttributeValues.bulkUpdateActivity');
